...
(function($) {
    ...
    $.jqplot.FunnelRenderer.prototype.draw = function (ctx, gd, options, plot) {
		...
		mask.beginPath();
		mask.moveTo(0,0);
		mask.bezierCurveTo( 40, 120, 80, 80, 80, 230);	
		mask.lineTo(150,230);
		mask.bezierCurveTo( 150, 80, 190, 120, 230, 0);
		mask.lineTo(0,0);
		mask.fill();
		mask.clip();
    ...
    function highlight (plot, sidx, pidx) {
		...
		canvas._ctx.moveTo(0,0);
		canvas._ctx.bezierCurveTo( 40, 120, 80, 80, 80, 230);	
		canvas._ctx.lineTo(150,230);
		canvas._ctx.bezierCurveTo( 150, 80, 190, 120, 230, 0);
