...
// PHPLOCKITOPT NOENCODE
  ...
  // Needs these parameters: Description (text description), ClassName (modify for each parser) and, AutoDiscoverable - true/false - must currently be true.
	$log_parser_types[] = Array("order" => "1", "Description" => "Apache Common/Combined with Cookie", "ClassName" => "ApacheCombinedCookieLogParser", "AutoDiscoverable" => true);

	class ApacheCombinedCookieLogParser extends GenericLogParser {
