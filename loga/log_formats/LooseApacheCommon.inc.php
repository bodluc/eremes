...
// PHPLOCKITOPT NOENCODE
  ...
  // Needs these parameters: Description (text description), ClassName (modify for each parser) and, AutoDiscoverable - true/false - must currently be true.
	$log_parser_types[] = Array("order" => "4", "Description" => "Loose Apache Common", "ClassName" => "LooseApacheCommonLogParser", "AutoDiscoverable" => true);

	class LooseApacheCommonLogParser extends GenericLogParser {
