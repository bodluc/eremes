...
// PHPLOCKITOPT NOENCODE
  ...
  // Needs these parameters: Description (text description), ClassName (modify for each parser) and, AutoDiscoverable - true/false - must currently be true.
	$log_parser_types[] = Array("order" => "12", "Description" => "Apache Common/Combined with trailing hostname", "ClassName" => "ApacheCommonWithHostname2", "AutoDiscoverable" => true);

	class ApacheCommonWithHostname2 extends GenericLogParser {
