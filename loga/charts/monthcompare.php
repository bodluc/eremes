...
$lastmonth[0]="<dataset seriesname=\"Visitors ".date("F",$from)."\" color=\"CCFFCC\" showValues=\"0\" alpha=\"70\">\n";
$thismonth[0]="<dataset seriesname=\"Visitors ".date("F",$to)."\" color=\"9999FF\" showValues=\"0\">\n";
 
while ($i <= $n) {
    $categories[$i]="  <category name=\"$i\" />\n";
    $lastmonth[$i]= "  <set value=\"0\" />\n";
    $thismonth[$i]= "  <set value=\"0\" />\n";
    $i++;
}
...
echo "</dataset>\n";
echo "<trendLines>";
echo "<line startValue=\"$lmavg\" endValue=\"$tmavg\" color=\"FF0000\" displayValue=\" \" thickness=\"2\" alpha=\"20\" isTrendZone=\"0\" showOnTop=\"0\" />";
echo "</trendLines>"; 
echo "</graph>"; ?>