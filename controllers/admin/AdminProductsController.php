...
class AdminProductsControllerCore extends AdminController
{
	...
	public function __construct()
	{
		...
		$this->fields_list['wholesale_price'] = array(
			'title' => $this->l('Hurt netto'),
			'width' => 50,
			'type' => 'price',
			'align' => 'right',
			'filter_key' => 'a!price'
		);
           $this->fields_list['hurt_brutto'] = array(
            'title' => $this->l('Hurt brutto'),
            'width' => 50,
            'type' => 'price',
            'align' => 'right',
            'filter_key' => 'a!price'
		...
		$this->fields_list['price_final'] = array(
			...
			'orderby' => false
              ...
              $this->fields_list['price_marza'] = array(
            'title' => $this->l('Marża'),
            'width' => 90,
            'type' => 'price',
            'align' => 'right',
        ...
        $this->fields_list['price_wars'] = array(
            'title' => $this->l('Cenowarki'),
            'width' => 400,
            'align' => 'right',
        );
	...
	public function ajaxProcessDeleteSpecificPrice($die=true)
	{
