...
$txt['whoall_quickmod'] = 'Modèrer une section.';
...
$txt['whoallow_optimizetables'] = 'Optimise les tables de données.';
$txt['whoallow_repairboards'] = 'Répare la base de données.';
$txt['whoallow_search'] = 'Effectue une <a href="' . $scripturl . '?action=search">Recherche</a>.';
...
$txt['whoallow_viewmembers'] = 'Consulte la liste des membres dans le Centre d\'Administration.';
...
// Credits text
$txt['credits'] = 'Crédits';
$txt['credits_intro'] = 'Simple Machines tient à remercier tous ceux qui ont contribué à faire de SMF 2.0 ce qu\'il est aujourd\'hui ; à façonner et diriger notre projet, contre vents et marées. Nous n\'y serions pas arrivés sans vous, nos utilisateurs, et en particulier nos Charter Members - merci d\'avoir installé notre logiciel et de l\'utiliser, ainsi que pour vos retours, vos rapports de bugs et vos avis.';
...
$txt['translation_credits'] = array(
        '<i>Traducteurs</i>&nbsp;:',
        'GravuTrad (<a href="http://www.simplemachines-fr.org/">SimpleMachines-Fr</a>)',
        'Maximus23',
        'Nao',
        'Chadon (<a href="http://www.mustangv8.com/fr/">Mustang V8</a>)',
        'DeathSign',
        'Eleglin',
