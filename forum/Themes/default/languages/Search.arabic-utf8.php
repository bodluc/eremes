...
$txt['any_words'] = 'مطابقة أي كلمة';
$txt['by_user'] = 'بواسطة المستخدم';
...
$txt['search_visual_verification_label'] = 'التحقق البصرى';
...
$txt['search_settings_title'] = 'خصائص البحث';

$txt['search_weights_desc'] = 'هنا تستطيع أن تغير الخيارات المستقلة للأشياء المرتبطة. ';
$txt['search_weights_title'] = 'بحث - وزن';
$txt['search_weights_total'] = 'الإجمالى';
...
$txt['search_method_fulltext_create'] = 'إنشاء فهرس نص كامل';
...
$txt['search_method_fulltext_warning'] = 'من أجل القدرة على استخدام بحث النص الكامل ,يجب عليك أن تنشأ فهرس النص الكامل أولا !';
...
$txt['search_index_sphinx_desc'] = 'لوحة الإدارة تسمح فقط التبديل بين فهارس البحث. من أجل تعديل خصائص Sphinx, استخدم أداة sphinx_config.php.';
$txt['search_index_label'] = 'فهرس';
$txt['search_index_size'] = 'حجم';
$txt['search_index_create_custom'] = 'إنشاء فهرس خاص';
$txt['search_index_custom_remove'] = 'حذف فهرس خاص';
// This string is used in a javascript confirmation popup; don't use entities.
...
$txt['search_create_index_not_ready'] = 'المنتدى يقوم الآن بإنشاء فهرس للمشاركات. لتجنب التحميل الزائد للسيرفر,فإن هذه العملية ستتم على مراحل. ستبدأ بالعمل بالمرحلة التالية بعد ثوان. في حال عدم الانتقال للمرحلة التالية اضغط على زر الاستمرار في الأسفل.';
$txt['search_create_index_progress'] = 'المعالجة';
$txt['search_create_index_done'] = 'تم إنشاء فهرس بحث خاص';
...
$txt['spider_mode'] = 'مستوى تتبع محركات البحث<div class="smalltext">لاحظ ان المستوى العالى جدا سيقوم بإرهاق خادم الموقع الخاص بك.</div>';
$txt['spider_mode_off'] = 'غير مفعل';
$txt['spider_mode_standard'] = 'قياسي - يسجل قليل من نشاط العنكبوت الالكتروني';
$txt['spider_mode_high'] = 'عالي - يوفر إحصائات أكثر دقة';
$txt['spider_mode_vhigh'] = 'عالى جدا - يشبه &quot;عالى&quot; لكنه يسجل كل خطوه و كل صفحه يزورها العنكبوت. ';
$txt['spider_settings_desc'] = 'من هنا يمكنك تغير إعدادات تتبع العناكب لموقعك. ملحوظه, إذا اردت تفعيل ميزة حذف السجلات تلقائيا فيمكنك عمل ذلك من  <a href="%1$s">هنا</a>';

$txt['spider_group'] = 'تطبيق تصريحات من مجموعة أعضاء<div class="smalltext">حتى تتمكن من إيقاف العناكب من تسجيل بعض صفحات الموقع بمحركات البحث.</div> ';
$txt['spider_group_none'] = 'غير مفعل';
...
$txt['spiders_remove_selected'] = 'إزالة العناكب الالكترونية المحددة';
$txt['spider_remove_selected_confirm'] = 'هل أنت متأكد من أنك تريد حذف هذا العنكبوت ؟\\n\\nجميع الإحصاءيات الخاصه به سيتم حذفها أيضا! ';
...
$txt['spider_disabled'] = 'غير مفعل';

$txt['spider_logs_delete'] = 'حذف المُدخلات';
$txt['spider_logs_delete_older'] = 'حذف كل المشاركات التي أقدم من';
$txt['spider_logs_delete_day'] = 'أيام.';
