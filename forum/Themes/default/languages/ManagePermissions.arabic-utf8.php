...
$txt['permissions_view'] = 'عرض';
$txt['permissions_allowed'] = 'مسموح';
$txt['permissions_denied'] = 'مرفوض';
$txt['permission_cannot_edit'] = '<strong>ملحوظه:</strong> لا يمكنك تعديل تصاريح الملف الشخصى هذا حيث انه مثبت فى نسخة المنتدى إفتراضيا. إذا أردت تغيير تصريحات هذا الملف الشخصى فيجب عليك أولا إنشاء ملف شخصى أخر يشبهه. و يمكنك فعل ذلك بالضغط <a href="%1$s">هنا</a>.';

$txt['permissions_for_profile'] = 'التصريحات الخاصه بالملف الشخصى ';
$txt['permissions_boards_desc'] = 'القائمة الموجودة بالأسف تعرض لك تصريحات الملف الشخصى لكل أقسام منتداك . يمكنك تعديل تصريحات الملفات الشخصيه هذه عن طريق
القائمة الموجودة بالأسف تعرض لك تصريحات الملف الشخصى لكل أقسام منتداك . يمكنك تعديل تصريحات الملفات الشخصيه هذه عن طريق الضغط على إسم المنتدى أو إختيار &quot;تعديل الكل&quot; الموجودة أسفل الصفحة. لتعديل تصريحات الملف الشخصى قم بالضغط على إسم الملف الشخصى. ';
$txt['permissions_board_all'] = 'تعديل الكل';
$txt['permission_profile'] = 'صلاحيات الملف الشخصي';
$txt['permission_profile_desc'] = 'ما هى <a href="%1$s">مجمعة الصلاحيات</a> التى تريد إستخدامها لهذا المنتدى. ';
$txt['permission_profile_inherit'] = 'مثل المنتدى الأصل الذي هو متفرع منه';

$txt['permissions_profile'] = 'العضوية';
$txt['permissions_profiles_desc'] = 'تصريحات الملفات الشخصية الخاصه بالمنتدى تتيح لك سهولة إدارة إعدادات الحماية . فى هذا القسم يمكنك إنشاء , تعديل و حذف تصريحات الملفات الشخصية .';
$txt['permissions_profiles_change_for_board'] = 'تعديل صلاحيات الحساب لـ: &quot;%1$s&quot;';
$txt['permissions_profile_default'] = 'افتراضي';
$txt['permissions_profile_no_polls'] = 'لا يوجد إستفتاءات';
$txt['permissions_profile_reply_only'] = 'رد فقط';
$txt['permissions_profile_read_only'] = 'قراءة فقط';

$txt['permissions_profile_rename'] = 'إعادة تسمية';
$txt['permissions_profile_edit'] = 'تعديل الحسابات';
$txt['permissions_profile_new'] = 'حساب جديد';
$txt['permissions_profile_new_create'] = 'إنشاء';
$txt['permissions_profile_name'] = 'اسم الحساب';
$txt['permissions_profile_used_by'] = 'مستخدم من قبل';
$txt['permissions_profile_used_by_one'] = 'قسم واحد';
$txt['permissions_profile_used_by_many'] = '%1$d أقسام';
$txt['permissions_profile_used_by_none'] = 'ولا منتدى';
$txt['permissions_profile_do_edit'] = 'تعديل';
$txt['permissions_profile_do_delete'] = 'حذف';
$txt['permissions_profile_copy_from'] = 'نسخ إسلوب الصلاحيات';

$txt['permissions_includes_inherited'] = 'المجموعات الوارثة';

$txt['permissions_all'] = 'كل';
$txt['permissions_none'] = 'بلا';
$txt['permissions_set_permissions'] = 'ضبط التصاريح';

$txt['permissions_advanced_options'] = 'خيارات متقدمه';
...
$txt['permissions_board_desc'] = '<strong>ملحوظه</strong>: تغير تصريحات الملف الشخصى الخاصة بهذا القسم سوف يؤثر على جميع الاقسام التى تعتمد على الملف الشخصى &quot;الإفتراضى&quot; . الاقسام التى لا تستخدم الملف الشخصى  &quot;الإفتراضى&quot; لن تتأثر بهذه التغييرات.';
...
$txt['permissions_option_desc'] = 'لكل تصريح يمكنك اختيار \'سماح\' (A), \'عدم سماح\' (X), أو <span style="color: red;">\'رفض\' (D)</span>.<br /><br />تذكر انك في حالة رفض التصريح, فأي عضو - سواء مراقب أو خلافه - في تلك المجموعة سيتم حظر التصريح عنه.<br />لهذا السبب يجب أن تتعامل مع الرفض بشكل حذر, و فقط في الحالات <strong>الضرورية</strong>. عدم السماح, ستقوم بالرفض ما لم يكن تم التصريح له.';
$txt['permissions_change_view'] = 'تغيير العرض';
$txt['permissions_view_simple'] = 'بسيط';
$txt['permissions_view_classic'] = 'كلاسيكي';
...
$txt['permissionhelp_calendar_view'] = 'يعرض التقويم أعياد الميلاد، الأحداث و الإجازات لكل شهر. عند تمكين هذا التصريح سيتم عرض زر التقويم في شريط الأزرار للمنتدى و سيتم عرض قائمة في أسفل فهرس المنتدى ، يحتوي على الأحداث القادمة. يجب تمكين التقويم في \'الخصائص المركزية\'.';
...
$txt['permissionhelp_admin_forum'] = 'هذا التصريح يسمح للمستخدم بـ:<ul class="normallist"><li>تغير إعدادات المنتدى ,قاعدة البيانات و القالب</li><li>إدارة الرزم</li><li> استخدام أدوات قاعدة بيانات المنتدى و الصيانة</li><li>مشاهدة سجل الإشراف و سجل أخطاء المنتدى</li></ul>  استخدم هذا التصريح بحذر, حيث انه قوى جداً. ';
...
$txt['permissionhelp_manage_smileys'] = 'هذا التصريح يسمح بالدخول إلى قسم الابتسامات ، حيث يمكن إضافة أو حذف أو تحرير الابتسامات و مجموعاتها. أيضاً فى حالة تفعيل خيار أيقونات المشاركات المخصصة فهذا التصريح سوف يسمح أيضاً بإضافة , حذف و تحرير هذه الأيقونات .';
...
$txt['permissionname_access_mod_center'] = 'الدخول على قسم الإشراف';
$txt['permissionhelp_access_mod_center'] = 'بهذا الخيار يمكن لكل عضو له هذه الصلاحية الدخول على مركز الإشراف حيث يمكنهم إدارة المجموعات عن طريق توابع لتسهيل الإشراف. لاحظ أن هذا الخيار لوحدة لا يعطي صلاحيات الإشراف.';

$txt['permissiongroup_member_admin'] = 'الاشراف على الاعضاء';
$txt['permissionname_moderate_forum'] = 'مراقبة أعضاء المنتدى';
$txt['permissionhelp_moderate_forum'] = 'هذا التصريح يحتوي على كافة الوظائف المهمة للتحكم العضو:<ul class="normallist"><li>معالج التسجيل</li><li>مشاهدة/حذف الأعضاء</li><li>مشاهدة الملف الشخصى بما فى ذلك حالة العضو إذا كان مخفى و عنوان الـ IP بالكامل</li><li>الموافقة على الحسابات</li><li>تنبيهات الموافقة على الحسابات و الإشعارات</li><li>التحكم فى تجاهل الرسائل الشخصية</li><li>و المزيد من الأشياء الصغيرة</li></ul> ';
...
$txt['permissionname_issue_warning'] = 'تحرير التحذيرات للأعضاء';
$txt['permissionhelp_issue_warning'] = 'تحرير تحذير لأعضاء المنتدى و تغير مستوى تحذير العضو. يتطلب تفعيل نظام التحذير.';
...
$txt['permissionname_profile_view_own'] = 'حسابهم';
$txt['permissionname_profile_view_any'] = 'أي حساب ';
...
$txt['permissionname_profile_identity_own'] = 'حسابهم';
$txt['permissionname_profile_identity_any'] = 'أي حساب ';
...
$txt['permissionname_profile_extra_own'] = 'حسابهم';
$txt['permissionname_profile_extra_any'] = 'أي حساب ';
...
$txt['permissionname_profile_title_own'] = 'حسابهم';
$txt['permissionname_profile_title_any'] = 'أي حساب ';
...
$txt['permissionname_profile_remove_own'] = 'حسابهم';
$txt['permissionname_profile_remove_any'] = 'أي حساب ';
...
$txt['permissionhelp_moderate_board'] = 'تصريح مراقبة المنتدى تمنح المراقب تصاريح إضافية لمراقبة. التصاريح الممنوحة تشتمل على الرد على موضوع مقفل، تغير مدة انتهاء صلاحية الاقتراع و شاهدة نتائج الاقتراع حتى و إن ';
...
$txt['permissionname_move_own'] = 'مواضيعهم';
...
$txt['permissionname_lock_own'] = 'مواضيعهم';
...
$txt['permissionname_remove_own'] = 'رسائلهم';
...
$txt['permissionname_post_reply_own'] = 'مواضيعهم';
...
$txt['permissionhelp_poll_view'] = 'هذا التصريح يسمح للمستخدم من مشاهدة الإستفتاء. من دون هذا التصريح فلن يشاهد المستخدم إلا الموضوع من دون الإستفتاء.';
...
$txt['permissionname_poll_post'] = 'كتابة إستفتاء';
$txt['permissionhelp_poll_post'] = 'هذا التصريح يسمح للمستخدم من كتابة إستفتاء جديد. لكون الإستفتاءات حالة خاصة من المواضيع ، فلا يمكنك استخدام هذا التصريح من دون تصريح إضافة موضوع جديد.';
$txt['permissionname_poll_add'] = 'إضافة إستفتاء إلى المواضيع';
$txt['permissionhelp_poll_add'] = 'إضافة إستفتاء إلى مواضيع تسمح للمستخدم من إضافة إستفتاء بعد أن يكون قد تم إنشاء الموضوع. يحتاج هذا التصريح إلى أحقية تحرير أو رسالة في الموضوع.';
$txt['permissionname_poll_add_own'] = 'مواضيعهم';
...
$txt['permissionname_poll_edit_own'] = 'إستفتاءاتهم';
...
$txt['permissionname_poll_lock_own'] = 'إستفتاءاتهم';
...
$txt['permissionname_poll_remove_own'] = 'إستفتاءاتهم';
$txt['permissionname_poll_remove_any'] = 'أي إستفتاء';

$txt['permissiongroup_approval'] = 'إشراف على المشاركات';
$txt['permissionname_approve_posts'] = 'الموافقه على العناصر التي تنتظر الموافقة';
$txt['permissionhelp_approve_posts'] = 'هذا الخيار يسمح للعضو بأن يوافق على جميع المشاركات الغير موافق عليها في المنتدى.';
$txt['permissionname_post_unapproved_replies'] = 'إرسال مشاركات غير موافق عليها';
$txt['permissionhelp_post_unapproved_replies'] = 'هذا الخيار يسمح للعضو بإرسال ردود على مواضيع والتي لن تظهر إلى أن يوافق عليها المشرف.';
$txt['permissionname_post_unapproved_replies_own'] = 'مواضيعهم';
$txt['permissionname_post_unapproved_replies_any'] = 'أي موضوع';
$txt['permissionname_post_unapproved_topics'] = 'إرسال مواضيع غير موافق عليها';
$txt['permissionhelp_post_unapproved_topics'] = 'هذا الخيار يسمح للعضو بإرسال مواضيع و التي لن تظهر إلى أن يتم الموافقة عليها من قبل المشرف.';
$txt['permissionname_post_unapproved_attachments'] = 'إرسال مرفقات غير موافق عليها';
$txt['permissionhelp_post_unapproved_attachments'] = 'هذا الخيار يسمح للعضو بإرسال ملفات مرفقة لكنها لن تظهر قبل أن يتم الموافقة عليها من قبل المشرف.';
...
$txt['permissionhelp_view_attachments'] = 'الملحقات هي عبارة عن ملفات يتم إلحاقها في الرسائل. يمكن تمكين و ضبط هذا الخيار في \'الملحقات و الصور الرمزية\'. بما أن الملحقات لا يتم الوصول إليها مباشرة ، فيمكنك حمايتهم من التنزيل بواسطة المستخدمين الذين لا يملكون هذا التصريح.';
...
$txt['permissiongroup_simple_view_basic_info'] = 'الإعدادات الأساسية للمنتدى';
$txt['permissiongroup_simple_use_pm_system'] = 'التواصل مع الأعضاء عن طريق الرسائل الخاصه';
$txt['permissiongroup_simple_post_calendar'] = 'إنشاء أحداث في التقويم';
$txt['permissiongroup_simple_edit_profile'] = 'تعديل إعدادات حسابهم';
$txt['permissiongroup_simple_delete_account'] = 'حذف حسابهم';
$txt['permissiongroup_simple_use_avatar'] = 'إختيار أو تحميل صورة شخصيه';
$txt['permissiongroup_simple_moderate_general'] = 'الاشراف على الاعضاء';
$txt['permissiongroup_simple_administrate'] = 'إشراف المنتدى';

$txt['permissionname_simple_calendar_edit_own'] = 'نعديل أحداثهم الموجوده بالتقويم';
$txt['permissionname_simple_calendar_edit_any'] = 'تعديل أى حدث موجود بالتقويم';
$txt['permissionname_simple_profile_view_own'] = 'مشاهدة ملخص حسابهم';
$txt['permissionname_simple_profile_view_any'] = 'مشاهدة  ملخصات حساب الأعضاء';
$txt['permissionname_simple_profile_identity_own'] = 'تعديل إعدادات حسابهم';
$txt['permissionname_simple_profile_identity_any'] = 'تعديل إعدادت أى حساب لأى عضو';
$txt['permissionname_simple_profile_extra_own'] = 'تحرير إعدادات حسابهم الإضافية';
$txt['permissionname_simple_profile_extra_any'] = 'تعديل  إعدادات الملف الشخصى لأى عضو';
$txt['permissionname_simple_profile_title_own'] = 'إختيار عنوان مخصص خاص بهم';
$txt['permissionname_simple_profile_title_any'] = 'تعديل العناوين المخصصه لأعضاء أخرين';
$txt['permissionname_simple_profile_remove_own'] = 'حذف حسابهم';
$txt['permissionname_simple_profile_remove_any'] = 'حذف حساب أى عضو';

$txt['permissiongroup_simple_make_unapproved_posts'] = 'كتابت مواضيع و ردود فى المنتدى <span style="text-decoration: underline">لكنها</span> لن تظهر إلا بعد الموافقه عليها';
$txt['permissiongroup_simple_make_posts'] = 'كتابت مواضيع و ردود فى المنتدى';
$txt['permissiongroup_simple_post_polls'] = 'كتابت إستفتاءات جديده';
$txt['permissiongroup_simple_participate'] = 'مشاهدة المحتويات المتقدمه للمنتدى';
$txt['permissiongroup_simple_modify'] = 'تعديل مشاركاتهم';
$txt['permissiongroup_simple_notification'] = 'طلب التنبيهات';
$txt['permissiongroup_simple_attach'] = 'إضافة ملحقات';
$txt['permissiongroup_simple_moderate'] = 'الإشراف على القسم';

$txt['permissionname_simple_post_unapproved_replies_own'] = 'كتابة ردود فى مواضيعهم - لكن تنتظر الموافقه';
$txt['permissionname_simple_post_unapproved_replies_any'] = 'كتابت ردود فى اى موضوع - لكن يجب الموافقه عليها ';
$txt['permissionname_simple_post_reply_own'] = 'كتابة ردود فى مواضيعهم';
$txt['permissionname_simple_post_reply_any'] = 'كتابت رد على أى موضوع';
$txt['permissionname_simple_move_own'] = 'نقل مواضيعهم';
$txt['permissionname_simple_move_any'] = 'نقل أى موضوع لأى عضو';
$txt['permissionname_simple_lock_own'] = 'قفل مواضيعهم';
$txt['permissionname_simple_lock_any'] = 'قفل أى موضوع لأى عضو';
$txt['permissionname_simple_remove_own'] = 'حذف مواضيعهم';
$txt['permissionname_simple_remove_any'] = 'حذف أى موضوع لأى عضو';
$txt['permissionname_simple_delete_own'] = 'حذف مشاركاتهم';
$txt['permissionname_simple_delete_any'] = 'حذف أى مشاركه لأى عضو';
$txt['permissionname_simple_modify_own'] = 'تعديل مشاركاتهم';
$txt['permissionname_simple_modify_any'] = 'تعديل مشاركات أى عضو';
$txt['permissionname_simple_poll_add_own'] = 'إضافة إستفتاء لمواضيعهم';
$txt['permissionname_simple_poll_add_any'] = 'كتابت إستفتاء فى أى موضوع لأى عضو';
$txt['permissionname_simple_poll_edit_own'] = 'تعديل إستفتاءاتهم';
$txt['permissionname_simple_poll_edit_any'] = 'تعديل أى إستفتاء لأى عضو';
$txt['permissionname_simple_poll_lock_own'] = 'قفل إستفتاءاتهم';
$txt['permissionname_simple_poll_lock_any'] = 'قفل أى إستفتاء لأى عضو';
$txt['permissionname_simple_poll_remove_own'] = 'حذف إستفتاءاتهم';
$txt['permissionname_simple_poll_remove_any'] = 'حذف أى إستفتاء لأى عضو';
...
$txt['permissions_post_moderation_desc'] = 'هذه الصفحة تمكنك بكل بساطة من تحديد تصريحات المواضيع لكل مجموعة و ذلك بإختيار الملف الشخصى .';
$txt['permissions_post_moderation_deny_note'] = 'لاحظ انه لان نظام التصريحات المتقدم يعمل فلا يمكنك تطبيق تصيرحات الملف الشخصى &quot;تقييدى&quot; من هذه الصفحة. رجاء قم بتعديل الملف الشخصى مباشرتا إذا كنت تريد تطبيق التصريح (تقييدى).';
$txt['permissions_post_moderation_select'] = 'إختر ملف شخصى';
$txt['permissions_post_moderation_new_topics'] = 'مواضيع جديده';
$txt['permissions_post_moderation_replies_own'] = 'ردودهم';
$txt['permissions_post_moderation_replies_any'] = 'أى ردود';
$txt['permissions_post_moderation_attachments'] = 'المرفقات';
$txt['permissions_post_moderation_legend'] = 'اسطورة';
$txt['permissions_post_moderation_allow'] = 'يستطيع إنشاء';
$txt['permissions_post_moderation_moderate'] = 'يستطيع إنشاء لكن تحتاج الى الموافقة';
$txt['permissions_post_moderation_disallow'] = 'لا يستطيع إنشاء';
$txt['permissions_post_moderation_group'] = 'مجموعة';

$txt['auto_approve_topics'] = 'كتابت موضوعات جديده , بدون الحاجه الى إنتظار الموافقه عليها';
$txt['auto_approve_replies'] = 'كتابت ردود على المواضيع , بدون الحاجه الى إنتظار الموافقه عليها';
$txt['auto_approve_attachments'] = 'إضافة مرفقات , بدون الحاجه الى إنتظار الموافقه عليها';
