...
$txt['mc_main'] = 'القسم الرئيس';
$txt['mc_posts'] = 'المشاركات';
$txt['mc_groups'] = 'مجموعات الأعضاء';

$txt['mc_view_groups'] = 'عرض مجموعات الأعضاء';

$txt['mc_description'] = 'هذا هو  &quot;قسم الإشراف&quot;. هنا تستطيع أن تمارس كل نشاطات و أحداث الإشراف الموكلة إليك من قبل الإدارة. تتضمن هذه الصفحة ملخص لكل الأشياء الحديثة التي تحدث في المنتدى. يمكنك تعديل توضع هذه الصفحة بما يناسبك من خلال الضغط <a href="' . $scripturl . '?action=moderate;sa=personalize">هنا</a>.';
$txt['mc_group_requests'] = 'طلب الانضمام إلى أحد المجموعات';
$txt['mc_unapproved_posts'] = 'مشاركات غير موافق عليها';
$txt['mc_watched_users'] = 'الأعضاء تحت المراقبة حالياً';
$txt['mc_watched_topics'] = 'مواضيع تحت المراقبة';
$txt['mc_scratch_board'] = 'منتدى المشرفين';
$txt['mc_latest_news'] = 'آخر أخبار منتديات smf';
$txt['mc_recent_reports'] = 'تقارير مواضيع جديدة';
$txt['mc_warnings'] = 'تحذيرات';
$txt['mc_notes'] = 'ملاحظات المشرفين';

$txt['mc_cannot_connect_sm'] = 'لا تستطيع الاتصال بمنتديات smf للحصول على آخر الأخبار.';
...
$txt['mc_groupr_reject_w_reason'] = 'رفص الطلب مع كتابة سبب الرفض';
// Do not use numeric entries in the below string.
...
$txt['mc_unapproved_replies'] = 'الردود';
$txt['mc_unapproved_topics'] = 'المواضيع';
$txt['mc_unapproved_by'] = 'بواسطة';
$txt['mc_unapproved_sure'] = 'هل أنت متأكد من أنك تريد فعل ذلك?';
$txt['mc_unapproved_attach_name'] = 'اسم الملف المرفق';
$txt['mc_unapproved_attach_size'] = 'حجم الملف';
$txt['mc_unapproved_attach_poster'] = 'المرسل';
$txt['mc_viewmodreport'] = 'تقرير للمشرف لـ %1$s بواسطة %2$s';
$txt['mc_modreport_summary'] = 'يوجد %1$d تقرير يتعلق بهذه المشاركة. التقرير الأخير كان %2$s.';
$txt['mc_modreport_whoreported_title'] = 'الأعضاء الذين كتبوا تقرير في هذه المشاركة';
$txt['mc_modreport_whoreported_data'] = 'تم كتابة تقرير بواسطة %1$s على  %2$s.  لقد تركوا الرسالة التالية:';
...
$txt['mc_warning_templates_title'] = 'تخصيص قالب تحذيرى';

$txt['mc_warnings_none'] = 'لم يتم إصدار أية تحذير!';
$txt['mc_warnings_recipient'] = 'المستقبل';

$txt['mc_warning_templates_none'] = 'لم يتم إضافة أى قالب تحذيرى حتى الأن';
$txt['mc_warning_templates_time'] = 'زمن الإنشاء';
$txt['mc_warning_templates_name'] = 'قالب';
...
$txt['mc_warning_template_delete'] = 'حذف المحدد';
$txt['mc_warning_template_delete_confirm'] = 'هل أنت متأكد من أنك تريد حذف القوالب التى قمت بإختيارها ؟';

$txt['mc_warning_template_desc'] = 'إستخدم هذه الصفحه لكتابت تفاصيل مضمون القالب. لاحظ أن عنوان الرساله ليس من مضمون القالب. لاحظ أنه بما أن التنبيه يتم إرساله كرساله شخصيه لذلك فإنه يمكنك إستخداد BBC فى مضمون القالب. لاحظ أنك إذا إستخدمت عبارة {MESSAGE} فإن هذا القالب لن يكون متاحا فى حالة إصدار تحذير عام (أى تحذير ليس له علاقة بموضوع). ';
$txt['mc_warning_template_title'] = 'عنوان القالب';
$txt['mc_warning_template_body_desc'] = 'مضمون رسالة التنبيه. لاحظ أنه يمكنك إستخدام هذه الإختصارات فى الرسالة.<ul style="margin-top: 0px;"><li>{MEMBER} - إسم العضو.</li><li>{MESSAGE} - رابط لموضوع الإعلان. (If Applicable)</li><li>{FORUMNAME} - إسم المنتدى.</li><li>{SCRIPTURL} - عنوان ويب المنتدى.</li><li>{REGARDS} - التوقيع النهائى.</li></ul>';
$txt['mc_warning_template_body_default'] = '{MEMBER},' . "\n\n" . 'لقد تلقيت تحذير بسبب ممارستك لأنشطه مخالفه لقوانين المنتدى. يرجى عدم تكرار ممارسة هذه الأنشطه المخالفه , و إتباع قوانين المنتدى و إلا سيتم إتباع إجراء أخر.' . "\n\n" . '{REGARDS}';
...
$txt['mc_warning_template_error_empty'] = 'يجب أن تكتب كل من عنوان و رسالة التنبيه .';

$txt['mc_prefs'] = 'تفضيلات';
...
$txt['mc_prefs_latest_news'] = 'أخبار SM';
...
$txt['mc_prefs_notify_report_never'] = 'أبدا';
