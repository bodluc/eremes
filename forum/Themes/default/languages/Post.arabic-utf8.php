...
$txt['enter_verification_details'] = 'أكمل تفاصيل التأكيد';
$txt['message_icon'] = 'أيقونة الرسالة';
$txt['subject_not_filled'] = 'خانة الموضوع تركت خالية وهي مطلوبة.';
$txt['message_body_not_filled'] = 'خانة النص تركت خالية وهي مطلوبة.';
// Use numeric entities in the below string.
$txt['regards_team'] = "تحياتنا,\nفريق " . $context['forum_name'] . ' .';
$txt['add_bbc'] = 'إضافة رموز BBC';
$txt['bold'] = 'سميك';
$txt['italic'] = 'مائل';
$txt['underline'] = 'تحته خط';
$txt['center'] = 'متوسط';
$txt['hyperlink'] = 'إضافة وصلة';
$txt['insert_email'] = 'إضافة بريد';
$txt['bbc_code'] = 'إضافة شفرة';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['bbc_quote'] = 'إضافة اقتباس';
$txt['list'] = 'لإضافة قائمة';
$txt['list_unordered'] = 'إدراج قائمة غير مرتبه';
$txt['list_ordered'] = 'إدراج قائمة مرتبه';
...
$txt['teal'] = 'مخضر';
$txt['navy'] = 'أزرق بحري';
$txt['maroon'] = 'أحمر داكن';
$txt['lime_green'] = 'أخضر ليموني';
$txt['white'] = 'أبيض';
...
$txt['excamation_point'] = 'علامة تعجب';
$txt['question_mark'] = 'علامة سؤال';
$txt['lamp'] = 'مصباح';
$txt['add_smileys'] = 'إضافة ابتسامات';
$txt['flash'] = 'إضافة فلاش';
$txt['ftp'] = 'لإضافة وصلة FTP';
$txt['image'] = 'إضافة صورة';
$txt['table'] = 'إضافة جدول';
$txt['table_td'] = 'إضافة عمود جدول';
$txt['topic_notify_no'] = 'لا يوجد مواضيع ذات تنبيهات.';
$txt['marquee'] = 'متحرك';
$txt['teletype'] = 'آلة كاتبة';
$txt['strike'] = 'يتوسطه خط';
$txt['glow'] = 'مشع';
$txt['shadow'] = 'ظل';
$txt['preformatted'] = 'نص منسق';
$txt['left_align'] = 'محاذاة لليسار';
$txt['right_align'] = 'محاذاة لليمين';
$txt['superscript'] = 'مرتفع';
$txt['subscript'] = 'منخفض';
$txt['table_tr'] = 'إضافة سطر جدول';
$txt['post_too_long'] = 'رسالتك طويلة جدا. الرجاء العودة و تقليل طولها و المعاودة مرة أخرى.';
$txt['horizontal_rule'] = 'خط أفقي';
$txt['font_size'] = 'حجم الخط';
$txt['font_face'] = 'نوع الخط';
$txt['toggle_view'] = 'عرض متناوب';
$txt['unformat_text'] = 'إزالة التنسيق';
...
$txt['shortcuts'] = 'إختصارات : اضغط alt+s للإضافة/الإرسال أو alt+p للمعاينة';
...
$txt['cant_upload_type'] = 'لا يمكنك إلحاق هذا النوع من الملفات. الملفات المسموح بها هي';
$txt['uncheck_unwatchd_attach'] = 'الغ التعليم عن الملحقات التي لا ترغب في إلحاقها';
$txt['restricted_filename'] = 'هذا اسم ملف ممنوع. حاول مع اسم ملف مختلف.';
$txt['topic_locked_no_reply'] = 'تحذير: الموضوع سوف يغلق أو تم إغلاقه!<br />فقط يحق للمراقبين و المشرفين الرد.';
$txt['awaiting_approval'] = 'ينتظر الموافقة';
$txt['attachment_requires_approval'] = 'لاحظ أن أي ملف مرفق لن يتم عرضه قبل أن يتم الموافقه عليه من قبل المشرف.';
$txt['error_temp_attachments'] = 'تم العثور على مرفقات, قد تم إرفاقها من قبل لكنك لم ترسلها. هذه المرفقات هى الان مرفقة مع هذه الرسالة. إذا كنت لا تريد إرفاقها مع هذه الرسالة, يمكنك حذفها <a href="#postAttachment">هنا</a>.';
// Use numeric entities in the below string.
...
$txt['attach_restrict_attachmentPostLimit'] = 'الحجم الأقصى الإجمالى  %1$dKB';
$txt['attach_restrict_attachmentSizeLimit'] = 'الحجم الأقصى للملف الواحد  %1$dKB';
$txt['attach_restrict_attachmentNumPerPostLimit'] = '%1$d لكل مشاركة';
$txt['attach_restrictions'] = 'القيود :';

$txt['post_additionalopt'] = 'خيارات إضافية...';
...
$txt['post_visual_verification_label'] = 'التحقق البصرى';
...
$txt['error_new_reply'] = 'تنبيه - بينما أنت تكتب تم إضافة رد جديد.';
$txt['error_new_replies'] = 'تنبيه - بينما أنت تكتب %1$d تم إضافة ردود جديدة.';
$txt['error_new_reply_reading'] = 'تنبيه - بينما أنت تقرا تم إضافة ردود جديدة.';
$txt['error_new_replies_reading'] = 'تنبيه - بينما أنت تقرءا %1$d تم إضافة ردود جديدة.';
...
$txt['announce_continue'] = 'مواصلة';
$txt['announce_topic'] = 'موضوع إعلاني.';
$txt['announce_regular_members'] = 'اعضاء عاديين';

$txt['digest_subject_daily'] = 'موجز يومي';
$txt['digest_subject_weekly'] = 'موجز أسبوعي';
$txt['digest_intro_daily'] = 'في الأسفل يوجد ملخص لجميع النشاطات التي سجلت بها للمواضيع و الأقسام في %1$s اليوم. لإبطال هذه التنبيهات اضغط على الرابط التالي في الأسفل.';
$txt['digest_intro_weekly'] = 'في الأسفل يوجد ملخص لجميع النشاطات التي سجلت بها من أجل متابعتها للأقسام و المواضيع في %1$s هذا الأسبوع. لإبطال هذه التنبيهات اضغط على الرابط التالي في الأسفل.';
$txt['digest_new_topics'] = 'المواضيع التالية قد تم إنشاءها ';
$txt['digest_new_topics_line'] = '"%1$s" في "%2$s" ';
