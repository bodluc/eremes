...
$txt['scheduled_tasks_enabled'] = 'مفعل';
$txt['scheduled_tasks_run_now'] = 'قم بتشغيل المهمة الآن';
$txt['scheduled_tasks_save_changes'] = 'حفظ التغييرات';
$txt['scheduled_tasks_time_offset'] = '<strong>ملحوظه:</strong> جميع الأوقات الموجوده أدناه هى على أساس <em>توقيت السرفر</em> و ليس لها علاقة بتوقيت المنتدى.';
$txt['scheduled_tasks_were_run'] = 'جميع المهمات المختاره تم الانتهاء منها';

$txt['scheduled_tasks_na'] = 'غير متوفر';
...
$txt['scheduled_task_auto_optimize'] = 'تحسين فاعلية قاعدة البيانات.';
...
$txt['scheduled_task_fetchSMfiles'] = 'البحث عن تحديثات للمنتدى';
$txt['scheduled_task_desc_fetchSMfiles'] = 'يقوم بالبحث عن التحديثات و أى معلومات مفيده بالموقع الرئيسى للمنتدى SMF .';
...
$txt['scheduled_task_reg_unit_d'] = 'يوم';
...
$txt['scheduled_log_empty_log'] = 'إفراغ السجل';
