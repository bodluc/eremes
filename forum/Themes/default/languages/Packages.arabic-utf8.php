...
$txt['package_proceed'] = 'مواصلة';
$txt['php_script'] = 'تم فك ملف المعدل، ولكنه يحتاج إلى النص البرمجي PHP الذي أتى معه لكي ينفذ قبل المعدل';
$txt['package_run'] = 'تنفيذ';
$txt['package_read'] = 'قراءة';
$txt['script_output'] = 'مخرجات النص البرمجي:';
$txt['additional_notes'] = 'تعليقات إضافية';
$txt['notes_file'] = 'ملف تعليمات/تعليقات إضافية';
$txt['list_file'] = 'عرض الملفات في الرزمة';
$txt['files_archive'] = 'الملفات في الأرشيف';
$txt['package_get'] = 'طلب الرزمة';
$txt['package_servers'] = 'ملقمات الرزم';
$txt['package_browse'] = 'استعرض';
$txt['add_server'] = 'إضافة ملقم';
$txt['server_name'] = 'اسم الملقم';
$txt['serverurl'] = 'رابط';
...
$txt['install_mod'] = 'تثبيت الرزمة';
$txt['uninstall_mod'] = 'إلغاء تثبيت الرزمة';
$txt['sql_file'] = 'تم فك ملف المعدل، ولكنه يحتاج إلى تطبيق ملف SQL لقاعدة البيانات، يفضل تنفيذ هذا اولا.';
$txt['sql_queries'] = 'SQL استعلامات';
$txt['no_mods_installed'] = 'لا يوجد رزم مُثبتة حاليا';
$txt['browse_installed'] = 'استعرض المعدلات المثبتة';
$txt['uninstall'] = 'إلغاء التثبيت';
$txt['delete_list'] = 'حذف قائمة الرزم';
$txt['php_safe_mode'] = 'نأسف و لكن ملقمك قد قام بوضع PHP في نمط SAFE MODE.  وهذه الميزة غير متوافقة مع النمط السابق، نأسف.';
$txt['lets_try_anyway'] = 'دعني أحاول على أية حال.';

$txt['package_manager_desc'] = 'بواسطة مدير الرزم يمكنك تحميل الرزم بكل سهولة.';
$txt['installed_packages_desc'] = 'في الاسفل ستجد الرزم المُثبتة و يمكنك حذفها في حالة عدم الحاجة لها.';
$txt['download_packages_desc'] = 'هنا يمكنك الاختيار بين تحميل الرزم من السيرفر او عن طريق تحميلها مباشرة الى المنتدى.';

$txt['create_package'] = 'إنشاء رزمة جديدة';
$txt['download_new_package'] = 'تحميل رزم جديدة';
$txt['view_and_remove'] = 'مشاهدة و حذف الرزم المثبتة';
$txt['modification_package'] = 'رزم الإضافات و التعديلات';
$txt['avatar_package'] = 'رزم الصور الشخصية';
$txt['language_package'] = 'رزم اللغات';
$txt['unknown_package'] = 'رزم غير معروفة';
$txt['use_avatars'] = 'إستخدام الصور الشخصية';
$txt['add_languages'] = 'إضافة لغة';
$txt['list_files'] = 'قائمة الملفات';
$txt['remove'] = 'حذف';
$txt['package_type'] = 'نوع الرزمة';
$txt['archiving'] = 'أرشفة';
$txt['extracting'] = 'فك ضغط';
$txt['avatars_extracted'] = 'تم فك ضغط الصور الشخصية، يمكنك استخدامهم الآن.';
$txt['language_extracted'] = 'تم فك ضغط ملفات اللغة ، يمكنك الآن استخدامها (بتحديدها في الإعدادات الخاصة بلغة المنتدى).';

$txt['mod_name'] = 'اسم الرزمة';
$txt['mod_version'] = 'الإصدار';
$txt['mod_author'] = 'المؤلف';
$txt['author_website'] = 'صفحة المؤلف';
$txt['package_no_description'] = 'لا يوجد وصف';
$txt['package_description'] = 'الوصف';
$txt['file_location'] = 'موقع الملف';

$txt['package_installed_key'] = 'الرزم المُثبتة:';
$txt['package_installed_current'] = 'الإصدار الحالي';
$txt['package_installed_old'] = 'إصدار قديم';
$txt['package_installed_warning1'] = 'هذه الرزمة مثبتة مسبق، ولا يوجد تحديث لها بعد!';
...
$txt['packages_latest'] = 'الرزم الحديثة';
$txt['packages_latest_fetch'] = 'محاولة الحصول على الرزم الحديثة من www.simplemachines.org...';
...
$txt['perform_actions'] = 'تثبيت هذه الرزمة سيقوم بإجراء الأحداث التالية:';
$txt['corrupt_compatible'] = 'الرزمة التى تحاول تحميلها أو تثبيتها ربما تكون معطوبة او غير متوافقة مع هذا الإصدار من المنتدى .';
$txt['package_create'] = 'إنشاء';
$txt['package_move'] = 'نقل';
$txt['package_delete'] = 'حذف';
$txt['package_extract'] = 'فك الضغط';
$txt['package_file'] = 'ملف';
$txt['package_tree'] = 'شجرة';
$txt['execute_modification'] = 'تنفيذ المعدل';
$txt['execute_code'] = 'تنفيذ الكود';
$txt['execute_database_changes'] = 'تنسيب قاعدة البيانات';

$txt['package_install_actions'] = 'تثبيت الرزمة';
$txt['package_will_fail_title'] = 'مشكلة في تثبيت الرزمة';
$txt['package_will_fail_warning'] = 'حدث خطا واحد على الاقل عند فحص هذه الرزمة.
	من المفضل <b>بشدة</b> عدم اكمال التثبيت الا اذا كنت تعرف ما تفعله. و المفضل عمل نسخة احتياطية عن المنتدى.
	من الممكن ان يكون سبب هذه المشكلة تثبيت زرمة تتعارض مع هذه الرزمة، او مشكلة في الزرمة، او ان هذه الرزمة تحتاج الى رزمة اخرى لتعمل، او ان هذه الرزمة مخصصة لاصدار اخر من ال SMF.';
// Don't use entities in the below string.
$txt['package_will_fail_popup'] = 'هل انت متاكد انك تريد اكمال تنصيب هذه الرزمة مع العلم انها من الممكن ان لا تعمل بشكل كامل؟';
$txt['package_will_fail_popup_uninstall'] = 'هل أنت متأكد من أنك تريد متابعة إلغاء تثبيت هذه الرزمه , على الرغم من أنه لن تتم عملية إلغاء التثبيت بنجاح ؟';
$txt['package_install_now'] = 'تثبيت الان';
$txt['package_uninstall_now'] = 'إلغاء التثبيت الأن';
$txt['package_other_themes'] = 'التثبيت في الإستايلات الاخرى';
$txt['package_other_themes_uninstall'] = 'إلغاء التثبيت فى الإستايلات الاخرى';
$txt['package_other_themes_desc'] = 'لكي تستخدم هذا المود في الإستايلات غير الافتراضية, مدير الرزم يحتاج للقيام ببعض التعديلات لباقي الإستايلات. إذا اردت أن تقوم بتثبيت هذا المود في الإستايلات الأخرى, برجاء اختيار هذه الإستايلات في الأسفل.';
// Don't use entities in the below string.
...
$txt['package_uninstall_done'] = 'تم إلغاء تثبيت الرزمة, من المفترض أن لا يكون لها تأثير.';
$txt['package_uninstall_cannot'] = 'لا يمكن إزالة هذه الرزمة, لعدم وجود ملف إلغاء التثبيت!<br /><br />الرجاء التواصل مع مؤلف الحزمة لمزيد من المعلومات.';
...
$txt['package_install_options_ftp_port'] = 'منفذ';
...
$txt['package_ftp_why'] = 'بعض الملفات التي تحتاجه هذه الرزمة لا يمكن الكتابة فيها.  يجب أن يتم تغير ذلك باستخدام FTP و تغير خصائص الملف.معلومات الـ FTP ربما تكون مُخزنه مؤقتاً من اجل العمليات السريعة الخاصة بمدير الرزم لاحظ أيضاً أنه يمكنك القيام بهذه العملية يدوياً من خلال عميل  FTP - لمشاهدة قائمة الملفات التى سوف يتم التعديل عليها برجاء الضغط <a href="#" onclick="%1$s">هنا</a>. ';
$txt['package_ftp_why_file_list'] = 'الملفات التالية يجب جعلها قابلة للكتابة لكي يتم إكمال عملية التثبيت:';
$txt['package_ftp_why_download'] = 'لتنزيل رزمة, فيجب أن يكون مجلد الرزم و الملفات داخله قابلة للكتابة - و هي ليست كذلك.  يمكن لمدير الرزم أن يستخدم إعدادات FTP الخاص بك لمحاولة إصلاح ذلك.';
$txt['package_ftp_server'] = 'سيرفر FTP ';
$txt['package_ftp_port'] = 'منفذ';
$txt['package_ftp_username'] = 'اسم المستخدم';
$txt['package_ftp_password'] = 'كلمة المرور';
$txt['package_ftp_path'] = 'المسار المحلي لـ SMF';
...
$txt['package_modification_malformed'] = 'ملف التعديل معطوب أو غير صحيح.';
...
$txt['package_db_uninstall'] = 'حذف كل المعطيات المرتبطة مع هذا المود ( التغيرات).';
$txt['package_db_uninstall_details'] = 'تفاصيل';
$txt['package_db_uninstall_actions'] = 'عند اختيار هذا الخيار سوف ينتج عنه التغيرات التالية في قواعد المعطيات';
...
$txt['package_advanced_button'] = 'متقدم';
$txt['package_advanced_options'] = 'خيارات متقدمة';
$txt['package_apply'] = 'تطبيق';
$txt['package_emulate'] = 'مُحاكاة النسخة';
$txt['package_emulate_revert'] = 'تراجع';
$txt['package_emulate_desc'] = 'أحيانا بعض الرزم مغلقة للنسخ القديمة من SMF لكنها تعمل في النسخ الجديدة. هنا يمكنك أن تختار &quot;مُحاكاة&quot;  نسخة SMF مختلفة ضمن مدير الرزم.';
...
$txt['package_file_perms_not_writable'] = 'غير قابل للكتابة';
...
$txt['package_file_perms_predefined_note'] = 'لاحظ ان هذا الخيار سيقوم بتغير صلاحيات الملفات الى الصلاحيات المحددة سابقا من قبل SMF على مجلدات و ملفات الـ SMF الرئيسية .';
...
$txt['package_file_perms_ftp_retain'] = 'ملحوظه, SMF ستقوم فقط بحفظ كلمة المرور بشكل مؤقت للمساعدة على تشغيل مدير الرزم .';
...
$txt['package_restore_permissions'] = 'استعادة صلاحيات الملف';
$txt['package_restore_permissions_desc'] = 'هذا الملف قد تم تغيير تصاريحه بواسطة SMF لكى يتم تثبيت الرزمة/الرزم المختارة. يمكنك إسترجاع التصاريح الاصلية لهذا الملف و ذلك بالضغط على &quot;إستعادة&quot; الموجودة بالأسفل. ';
...
$txt['package_restore_permissions_action_success'] = '<span style="color: green;">نجح</span>';
$txt['package_restore_permissions_action_failure'] = '<span class="error">فشل</span>';
$txt['package_restore_permissions_action_done'] = 'SMF قد حاولت إسترجاع التصريحات الأصلية للملفات المختارة, ستجد مزيد من التفاصيل بالاسفل. إذا لم تحدث تغيرات, او لمزيد من التفاصيل حول تصاريح الملفات, رجاء إلقى نظره على قسم <a href="%1$s">صلاحيات الملفات</a> . ';

$txt['package_file_perms_warning'] = 'نرجو الملاحظة';
$txt['package_file_perms_warning_desc'] = '<li>كن حذيرا عند تغيير تصريحات الملفات من هنا  - التصريحات الخطأ قد تقوم بتعطيل منتاك !</li> <li>فى بعض السرفرات إذا قمت بعمل تصريحات خطأ فإن هذا قد يوقم منتداك عن العمل.</li> <li>بعض المجلدات مثل <i>attachments</i> يجب أن يكون قابل للكتابه.</li> <li>هذه المميزات تعمل بشكل اساسى على السرفرات التى تعمل بأى نظام غير نظام الوندوز  - فإنها لن تعمل بشكل جيد على الخوادم التى تستخدم نظام ويندوز.</li> <li>قبل أن تبدأ تأكد من وجود حساب FTP مثبت حتى تتمكن من تصحيح أى خطأ قد يحدث .</li>';

$txt['package_confirm_view_package_content'] = 'هل أنت متأكد من أنك تريد مشاهدة محتويات هذه الرزمه من هنا :<br /><br />%1$s ';
$txt['package_confirm_proceed'] = 'متابعة';
$txt['package_confirm_go_back'] = 'العودة';

$txt['package_readme_default'] = 'الإفتراضى';
