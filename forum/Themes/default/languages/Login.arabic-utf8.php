...
$txt['registration_agreement'] = 'إتفاقية التسجيل';
...
$txt['choose_username'] = 'اختر اسم المستخدم';
$txt['maintain_mode'] = 'نمط الصيانة';
$txt['registration_successful'] = 'تم التسجيل بنجاح';
$txt['now_a_member'] = 'نجح التسجيل! أنت الآن عضو في هذا المنتدى.';
// Use numeric entities in the below string.
$txt['your_password'] = 'و كلمة المرور هي';
$txt['valid_email_needed'] = 'الرجاء إدخال بريد صحيح, %1$s.';
$txt['required_info'] = 'معلومات مطلوبة';
$txt['identification_by_smf'] = 'يُستعمل فقط لتعريفك فى المنتدى.';
...
$txt['login_below'] = 'الرجاء تسجيل الدخول في الأسفل أو';
$txt['register_an_account'] = 'قم بالتسجيل';
$txt['login_with_forum'] = 'فى %1$s.';
// Use numeric entities in the below two strings.
$txt['may_change_in_profile'] = 'يمكنك تغيّره بعد تسجيل الدخول بالذهاب إلى صفحة الملف الشخصى، أو زيارة الصفحة التالية بعد تسجيل الدخول:';
$txt['your_username_is'] = 'اسم المستخدم هو: ';
...
$txt['change_password_login'] = 'بيانات تسجيل الدخول في';
$txt['change_password_new'] = 'تم تغيره و إعادة ضبط كلمة المرور. في الأسفل بيانات تسجيل الدخول الجديدة.';
...
$txt['coppa_after_registration'] = 'شكرا لتسجيلك في ' . $context['forum_name_html_safe'] . '.<br /><br /> ولأنك تندرج تحت العمر المطلوب الذي هو {MINIMUM_AGE}, فإنه لا بد من الحصول على موافقة والديك/ ولي أمرك  قبل أن تبدأ بإستخدام العضوية. ولترتيب تفعيل العضوية نرجو طباعة النموذج أدناه:';
...
$txt['coppa_form_title'] = 'طلب سماح الانتساب للمنتدى ' . $context['forum_name_html_safe'];
$txt['coppa_form_address'] = 'العنوان';
$txt['coppa_form_date'] = 'تاريخ';
$txt['coppa_form_body'] = 'أنا {PARENT_NAME},<br /><br />أعطي الصلاحية لـ{CHILD_NAME} (اسم الطفل) ليصبح عضو مسجل بشكل كامل في المنتدى : ' . $context['forum_name'] . ', باستخدام اسم المستخدم: {USER_NAME}.<br /><br />افهم أن بعض المعلومات الشخصية المدخلة من قبل {USER_NAME} قد يتم عرضها لباقي الأغضاء في المنتدى.<br /><br />التوقيع:<br />{PARENT_NAME} (الأب/الواصى).';
