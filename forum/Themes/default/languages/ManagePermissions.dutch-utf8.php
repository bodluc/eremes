...
$txt['permissions_view'] = 'Bekijk';
$txt['permissions_allowed'] = 'Toegekend';
$txt['permissions_denied'] = 'Ontzegd';
$txt['permission_cannot_edit'] = '<strong>Opmerking:</strong> Je kunt dit permissieprofiel niet bewerken, aangezien het een vooraf gedefinieerd profiel is dat standaard met in de forumsoftware wordt geleverd. Als je de permissies van dit profiel wilt wijzigen, kun je dat het makkelijkst doen door een kopie van dit profiel te maken. Je kunt dit doen door <a href="%1$s">hier</a> te klikken.';

$txt['permissions_for_profile'] = 'Permissies van profiel';
$txt['permissions_boards_desc'] = 'De lijst hieronder toont welk permissieprofiel is toegekend aan welk board van je forum. Je kunt het toegekende permissieprofiel wijzigen door ofwel de naam van het board aan te klikken, ofwel voor &quot;bewerk alles&quot; aan de onderkant van de pagina te selecteren. Om het profiel in kwestie te wijzigen, klik je simpelweg de profielnaam aan.';
$txt['permissions_board_all'] = 'Bewerk alles';
$txt['permission_profile'] = 'Permissieprofiel';
$txt['permission_profile_desc'] = 'Welk <a href="%1$s">permissieprofiel</a> het board zou moeten gebruiken.';
$txt['permission_profile_inherit'] = 'Erven van bovenliggend board';

$txt['permissions_profile'] = 'Profiel';
$txt['permissions_profiles_desc'] = 'Permissieprofielen worden toegekend aan individuele boards om je in staat te stellen eenvoudiger permissies te beheren. Vanuit hier kun je permissieprofielen maken, bewerken en verwijderen.';
$txt['permissions_profiles_change_for_board'] = 'Bewerk permissieprofiel voor: &quot;%1$s&quot;';
$txt['permissions_profile_default'] = 'Standaard';
$txt['permissions_profile_no_polls'] = 'Geen polls';
$txt['permissions_profile_reply_only'] = 'Alleen reageren';
$txt['permissions_profile_read_only'] = 'Alleen lezen';

$txt['permissions_profile_rename'] = 'Hernoem';
$txt['permissions_profile_edit'] = 'Bewerk profielen';
$txt['permissions_profile_new'] = 'Nieuw profiel';
$txt['permissions_profile_new_create'] = 'Nieuw';
$txt['permissions_profile_name'] = 'Profielnaam';
$txt['permissions_profile_used_by'] = 'Gebruikt door';
$txt['permissions_profile_used_by_one'] = '1 board';
$txt['permissions_profile_used_by_many'] = '%1$d boards';
$txt['permissions_profile_used_by_none'] = 'Geen boards';
$txt['permissions_profile_do_edit'] = 'Bewerk';
$txt['permissions_profile_do_delete'] = 'Verwijder';
$txt['permissions_profile_copy_from'] = 'Kopieer permissies van';

$txt['permissions_includes_inherited'] = 'Ervende groepen';

$txt['permissions_all'] = 'alle';
$txt['permissions_none'] = 'geen';
$txt['permissions_set_permissions'] = 'Stel permissies in';

$txt['permissions_advanced_options'] = 'Geavanceerde opties';
...
$txt['permissions_board'] = 'Standaard boardpermissies';
$txt['permissions_board_desc'] = '<strong>Opmerking:</strong> als je deze boardpermissies aanpast, zal dat invloed hebben op alle boards die momenteel het permissieprofiel &quot;Standaard&quot; toegekend hebben. Boards die geen gebruik maken van dit profiel zullen niet be&iuml;nvloed worden door de wijzigingen op deze pagina.';
$txt['permissions_commit'] = 'Opslaan';
$txt['permissions_on'] = 'in profiel';
$txt['permissions_local_for'] = 'Permissies voor groep';
$txt['permissions_option_on'] = 'T';
$txt['permissions_option_off'] = 'N';
$txt['permissions_option_deny'] = 'O';
$txt['permissions_option_desc'] = 'Voor iedere permissie kun je kiezen uit \'Toestaan\' (T), \'Niet-toestaan\' (N), of <span style="color: red;">\'Ontzeggen\' (O)</span>.<br /><br />Onthoud dat bij het ontzeggen van een permissie, ieder lid - moderator of niet - in die groep die permissie zal worden ontzegd.<br />Om deze reden, dien je voorzichtig met het ontzeggen van permissies om te gaan; gebruik ze alleen wanneer <strong>noodzakelijk</strong>. \'Niet toestaan\' is een voorzichtiger alternatief, dat alleen ontzegd tenzij de permissie op andere wijze wordt toegekend.';
$txt['permissions_change_view'] = 'Verander modus';
$txt['permissions_view_simple'] = 'Eenvoudig';
$txt['permissions_view_classic'] = 'Klassiek';
...
$txt['permissionname_view_mlist'] = 'Bekijk de ledenlijst en -groepen';
$txt['permissionhelp_view_mlist'] = 'De ledenlijst toont alle geregistreerde leden van het forum. De lijst kan worden gesorteerd en worden doorzocht. De lijst is gelinkt vanaf de forum index en de statistieken pagina, door te klikken op het aantal leden. Het is ook van toepassing op de groepenpagina, die een overzicht toont van de leden in een bepaalde groep.';
...
$txt['permissionhelp_calendar_view'] = 'De kalender toont voor iedere maand de verjaardagen, gebeurtenissen en feestdagen. Met deze permissie krijgt de gebruiker toegang tot de kalender. Als deze permissie is geactiveerd, verschijnt er een knop in de menubalk en zal er een lijst verschijnen onderaan de forumindexpagina met daarop de huidige en aankomende verjaardagen, gebeurtenissen en feestdagen. De kalender dient dan wel te zijn geactiveerd in \'Basisfeatures\'.';
...
$txt['permissionname_manage_smileys'] = 'Beheer smileys en berichticonen';
$txt['permissionhelp_manage_smileys'] = 'Hiermee kan toegang worden verkregen tot het smileybeheer. In het smileybeheer kun je smileys en smileysets toevoegen, bewerken en verwijderen. Als je aangepaste berichticonen hebt ingeschakeld, zal deze permissie ook toegang geven tot het toevoegen en bewerken van deze iconen.';
...
$txt['permissionname_access_mod_center'] = 'Toegang tot moderatiecentrum';
$txt['permissionhelp_access_mod_center'] = 'Met deze permissie kunnen leden van deze groep toegang verkrijgen tot het moderatiecentrum, vanwaar ze toegang krijgen tot functies die het modereren vergemakkelijken. Merk op dat dit op zich geen moderatierechten geeft.';

$txt['permissiongroup_member_admin'] = 'Ledenbeheer';
$txt['permissionname_moderate_forum'] = 'Beheer forumleden';
$txt['permissionhelp_moderate_forum'] = 'Deze permissie omvat alle belangrijke functies voor ledenbeheer:<ul class="normallist"><li>toegang tot registratiebeheer</li><li>toegang tot \'bekijk/verwijder leden\'-scherm</li><li>uitgebreide profielinformatie, inclusief IP-tracering en (verborgen) online status</li><li>accountactivatie</li><li>ontvang lidgoedkeuringsnotificaties en accountgoedkeuring</li><li>immuun voor PM-negeerlijst</li><li>verscheidene kleine zaken</li></ul>';
...
$txt['permissionname_issue_warning'] = 'Geef waarschuwing aan leden';
$txt['permissionhelp_issue_warning'] = 'Geef een waarschuwing aan leden van het forum en bewerk het waarschuwingsniveau van het lid in kwestie. Vereist dat het waarschuwingssysteem is ingeschakeld.';
...
$txt['permissionhelp_post_new'] = 'Deze permissie staat gebruikers toe om nieuwe topics te plaatsen. Met alleen deze permissie is het nog niet mogelijk om te reageren in een topic.';
...
$txt['permissionhelp_poll_post'] = 'Deze permissie stelt een lid in staat een nieuwe poll te plaatsen. Het lid in kwestie moet dan wel over de permissie \'Start nieuwe topics\' beschikken.';
...
$txt['permissiongroup_approval'] = 'Berichtmoderatie';
$txt['permissionname_approve_posts'] = 'Keur items wachtend op goedkeuring goed';
$txt['permissionhelp_approve_posts'] = 'Deze permissie stelt gebruikers in staat om berichten in de wachtrij van een board goed te keuren.';
$txt['permissionname_post_unapproved_replies'] = 'Plaats reacties in topics, maar verberg ze tot ze zijn goedgekeurd';
$txt['permissionhelp_post_unapproved_replies'] = 'Deze permissie stelt gebruikers in staat te posten in een topic, maar het bericht moet wel goedgekeurd worden door een moderator.';
$txt['permissionname_post_unapproved_replies_own'] = 'Eigen topics';
$txt['permissionname_post_unapproved_replies_any'] = 'Elk topic';
$txt['permissionname_post_unapproved_topics'] = 'Plaats nieuwe topics, maar verberg ze tot ze zijn goedgekeurd';
$txt['permissionhelp_post_unapproved_topics'] = 'Deze permissie stelt een lid in staat een topic te posten, maar het topic moet wel eerst goedgekeurd worden door een moderator.';
$txt['permissionname_post_unapproved_attachments'] = 'Plaats bijlagen, maar verberg ze tot ze zijn goedgekeurd';
$txt['permissionhelp_post_unapproved_attachments'] = 'Deze permissie stelt gebruikers in staat om bijlagen aan hun posts toe te voegen, welke dan eerst goedgekeurd dienen te worden door een moderator alvorens ze getoond worden.';
...
$txt['permissiongroup_simple_view_basic_info'] = 'Gebruik basis-forumfunctionaliteit';
$txt['permissiongroup_simple_use_pm_system'] = 'Leden contacteren via het persoonlijke berichtensysteem';
$txt['permissiongroup_simple_post_calendar'] = 'Gebeurtenissen op de kalender plaatsen';
$txt['permissiongroup_simple_edit_profile'] = 'Eigen profiel personaliseren';
$txt['permissiongroup_simple_delete_account'] = 'Eigen account verwijderen';
$txt['permissiongroup_simple_use_avatar'] = 'Avatar kiezen of uploaden';
$txt['permissiongroup_simple_moderate_general'] = 'Modereer het hele forum';
$txt['permissiongroup_simple_administrate'] = 'Administratieve zaken uitvoeren';

$txt['permissionname_simple_calendar_edit_own'] = 'Eigen kalendergebeurtenissen bewerken';
$txt['permissionname_simple_calendar_edit_any'] = 'Kalendergebeurtenissen van anderen bewerken';
$txt['permissionname_simple_profile_view_own'] = 'Eigen profiel bekijken';
$txt['permissionname_simple_profile_view_any'] = 'Profiel van anderen bekijken';
$txt['permissionname_simple_profile_identity_own'] = 'Eigen accountinstellingen aanpassen';
$txt['permissionname_simple_profile_identity_any'] = 'Accountinstellingen van anderen aanpassen';
$txt['permissionname_simple_profile_extra_own'] = 'Eigen additionele profielinstellingen aanpassen';
$txt['permissionname_simple_profile_extra_any'] = 'Additionele profielinstellingen van anderen aanpassen';
$txt['permissionname_simple_profile_title_own'] = 'Een aangepaste titel voor zichzelf kiezen';
$txt['permissionname_simple_profile_title_any'] = 'Een aangepaste titel voor anderen kiezen';
$txt['permissionname_simple_profile_remove_own'] = 'Eigen account verwijderen';
$txt['permissionname_simple_profile_remove_any'] = 'Accounts van anderen verwijderen';

$txt['permissiongroup_simple_make_unapproved_posts'] = 'Plaats topics en reacties in het board, <span style="text-decoration: underline">alleen</span> nadat ze zijn goedgekeurd';
$txt['permissiongroup_simple_make_posts'] = 'Plaats topics en reacties in het board';
$txt['permissiongroup_simple_post_polls'] = 'Nieuwe polls aanmaken';
$txt['permissiongroup_simple_participate'] = 'Bekijken van extra boardinhoud';
$txt['permissiongroup_simple_modify'] = 'Eigen posts aanpassen';
$txt['permissiongroup_simple_notification'] = 'Notificaties aanvragen';
$txt['permissiongroup_simple_attach'] = 'Bijlagen plaatsen';
$txt['permissiongroup_simple_moderate'] = 'Het board modereren';

$txt['permissionname_simple_post_unapproved_replies_own'] = 'Plaats reacties in eigen topics - maar vereis goedkeuring';
$txt['permissionname_simple_post_unapproved_replies_any'] = 'Plaats reacties in elk topic - maar vereis goedkeuring';
$txt['permissionname_simple_post_reply_own'] = 'Plaats reacties in een topic dat ze zelf hebben gestart';
$txt['permissionname_simple_post_reply_any'] = 'Plaats reacties in elk topic';
$txt['permissionname_simple_move_own'] = 'Verplaats eigen topics';
$txt['permissionname_simple_move_any'] = 'Verplaats alle topics';
$txt['permissionname_simple_lock_own'] = 'Sluit eigen topics';
$txt['permissionname_simple_lock_any'] = 'Sluit alle topics';
$txt['permissionname_simple_remove_own'] = 'Verwijder eigen topics';
$txt['permissionname_simple_remove_any'] = 'Verwijder topics van iedereen';
$txt['permissionname_simple_delete_own'] = 'Verwijder een eigen bericht';
$txt['permissionname_simple_delete_any'] = 'Verwijder berichten van iedereen';
$txt['permissionname_simple_modify_own'] = 'Verander eigen berichten';
$txt['permissionname_simple_modify_any'] = 'Verander berichten van anderen';
$txt['permissionname_simple_poll_add_own'] = 'Voeg een poll toe aan een bestaand eigen topic';
$txt['permissionname_simple_poll_add_any'] = 'Voeg een poll toe aan een willekeurig topic';
$txt['permissionname_simple_poll_edit_own'] = 'Bewerk een eigen poll';
$txt['permissionname_simple_poll_edit_any'] = 'Bewerk een willekeurige poll';
$txt['permissionname_simple_poll_lock_own'] = 'Sluit eigen polls';
$txt['permissionname_simple_poll_lock_any'] = 'Sluit polls van anderen';
$txt['permissionname_simple_poll_remove_own'] = 'Verwijder een eigen poll';
$txt['permissionname_simple_poll_remove_any'] = 'Verwijder een poll van anderen';
...
$txt['permissions_post_moderation_desc'] = 'Vanuit deze pagina kun je eenvoudig wijzigen van welke ledengroepen berichten gemodereerd moeten worden bij een bepaald permissieprofiel.';
$txt['permissions_post_moderation_deny_note'] = 'NB: zolang geavanceerde permissies ingeschakeld zijn, is het niet mogelijk om vanuit deze pagina de &quot;ontzeg&quot;-permissie toe te passen. Bewerk de permissies rechtstreeks als je permissies wilt ontzeggen.';
$txt['permissions_post_moderation_select'] = 'Kies profiel';
$txt['permissions_post_moderation_new_topics'] = 'Nieuwe topics';
$txt['permissions_post_moderation_replies_own'] = 'Eigen reacties';
$txt['permissions_post_moderation_replies_any'] = 'Alle reacties';
$txt['permissions_post_moderation_attachments'] = 'Bijlagen';
$txt['permissions_post_moderation_legend'] = 'Legenda';
$txt['permissions_post_moderation_allow'] = 'Toegestaan';
$txt['permissions_post_moderation_moderate'] = 'Toegestaan, maar vereist goedkeuring';
$txt['permissions_post_moderation_disallow'] = 'Niet toegestaan';
$txt['permissions_post_moderation_group'] = 'Groep';

$txt['auto_approve_topics'] = 'Plaats nieuwe topics, zonder goedkeuring te eisen';
$txt['auto_approve_replies'] = 'Plaats reacties in topics, zonder goedkeuring te eisen';
$txt['auto_approve_attachments'] = 'Plaats bijlagen, zonder goedkeuring te eisen';
