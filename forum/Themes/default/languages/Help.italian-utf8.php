...
$helptxt['featuresettings'] = '<strong>Modifica Funzionalità e Opzioni</strong><br /> In questa sezione sono presenti diverse funzionalità che potrai modificare a tuo piacimento.';
...
$helptxt['meta_keywords'] = 'Queste parole chiave vengono inviate nell\'output di ogni pagina per indicare ai motori di ricerca (ect) i contenuti chiave del tuo sito. Le parole devono essere separate da virgole e non è permesso l\'utilizzo di codice HTML. Se la lista viene lasciata in bianco, verrà inviato il set default di parole chiave. Un esempio di questa lista è:<br /><div class="smalltext">&quot;PHP, MySQL, bulletin, board, free, open, source, smf, simple, machines, forum&quot;</div>';
