...
$txt['boardConfirm'] = 'Weet je zeker dat je dit board wilt verwijderen?';

$txt['catEdit'] = 'Bewerk categorie';
$txt['collapse_enable'] = 'Inklapbaar';
$txt['collapse_desc'] = 'Sta gebruikers toe om deze categorie in te klappen';
$txt['catModify'] = '(bewerk)';
...
$txt['mboards_description_desc'] = 'Een korte beschrijving van je board.';
...
$txt['mboards_theme_desc'] = 'Dit staat je toe om het thema van de boards onderling aan te passen.';
...
$txt['mboards_redirect_url_desc'] = 'Bijvoorbeeld: &quot;http://www.simplemachines.org&quot;.';
...
$txt['mboards_redirect_disabled'] = 'NB: het board moet leeg zijn om dit aan te kunnen zetten.';
$txt['mboards_redirect_disabled_recycle'] = 'NB: je kunt het prullenbakboard niet tot een doorschakelend board maken.';
