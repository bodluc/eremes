...
$txt['profile_warning_notify_template_outline'] = '{MEMBER},' . "\n\n" . 'Vous avez re&#231;u un avertissement pour %1$s. Merci de cesser ces activit&#233;s et de respecter les r&#269;gles du forum, sans quoi nous devrons prendre d\'autres mesures.' . "\n\n" . '{REGARDS}';
$txt['profile_warning_notify_template_outline_post'] = '{MEMBER},' . "\n\n" . 'Vous avez re&#231;u un avertissement pour %1$s en rapport avec ce message :' . "\n" . '{MESSAGE}.' . "\n\n" . 'Merci de cesser ces activit&#233;s et de respecter les r&#269;gles du forum, sans quoi nous devrons prendre d\'autres mesures.' . "\n\n" . '{REGARDS}';
...
$txt['pm_recommend_enable_outbox'] = 'Pour profiter au mieux de ce param&egrave;tre, nous vous sugg&eacute;rons d\'activer &quot;Sauvegarder par d&eacute;faut une copie de mes messages personnels dans ma bo&icirc;te d\'envoi.&quot;\\n\\nCela vous aidera &agrave; suivre plus facilement les conversations puisque vous verrez les deux moiti&eacute;s de chaque conversation.';
