...
$txt['admin_users'] = 'مشاهدة/حذف الأعضاء';
$txt['admin_newsletters'] = 'إرسال بريد للأعضاء';
$txt['admin_edit_news'] = 'تحرير الأخبار';
$txt['admin_groups'] = 'تحرير مجموعات الأعضاء';
...
$txt['admin_censored_where'] = 'كلمة واحدة لكل سطر مثل: حمار=ح**ر';
$txt['admin_censored_desc'] = 'نظراً لطبيعة عمل المنتديات، فقد تكون هنالك بعض الكلمات التي تريد أن تمنع الأعضاء من نشرها. هنا يمكنك إضافة الكلمات التي تريد أن يتم تشفيرها عند استخدامها من قبل أحد الأعضاء.';
$txt['admin_reserved_names'] = 'ضبط الأسماء المحجوزة';
$txt['admin_template_edit'] = 'تحرير قالب المنتدى';
$txt['admin_modifications'] = 'إعدادات التعديلات';
...
$txt['cookie_name'] = 'اسم السكاكر (الكوكيز)';
$txt['admin_webmaster_email'] = 'بريد مدير الموقع';
$txt['boarddir'] = 'SMF مجلد';
$txt['sourcesdir'] = 'Sources مجلد';
$txt['cachedir'] = 'مجلد الكاش';
$txt['admin_news'] = 'تفعيل الأخبار؟';
$txt['admin_guest_post'] = 'تمكين الضيوف من المشاركة في المنتدى؟';
$txt['admin_manage_members'] = 'تحكم الأعضاء';
$txt['admin_main'] = 'تحكم المنتدى';
$txt['admin_config'] = 'إعدادات المنتدى';
$txt['admin_version_check'] = 'فحص مفصل للإصدارة';
$txt['admin_smffile'] = 'SMF ملف';
$txt['admin_smfpackage'] = 'SMF رزمة';
...
$txt['admin_main_welcome'] = 'هذا هو "%1$s". هنا يمكنك أن تقوم بتحرير الإعدادات، صيانة المنتدى، مشاهدة السجلات، تثبيت الرزم، معالجة القوالب والعديد من المهام الأخرى.<div style="margin-top: 1ex;">إن واجهتك أي مشكلة فالرجاء الرجوع إلى قسم الدعم الفني. إن لم تجد حلاً لمشكلتك هناك فيمكنك <a href="http://www.simplemachines.org/community/index.php" target="_blank" class="new_win">طلب المساعدة منا</a>.</div>كما ويمكنك أيضاً إيجاد أجوبة لتساؤلاتك من خلال زيارة <img src="' . $settings['images_url'] . '/helptopics.gif" alt="%2$s" title="%3$s" /> لعرض المزيد من التعليمات المتعلقة بمشكلتك.';
$txt['admin_news_desc'] = 'الرجاء كتابة خبر واحد فقط في كل صندوق. يمكنك استخدام ترميز BBC مثل: <span title="سميك">[b]</span>, <span title="مائل">[i]</span> و <span title="تحته خط">[u]</span> كما ويمكنك استخدام الابتسامات . لحذف خبر غير مرغوب به قم بإفراغ الصندوق الذي يحتوي على ذلك الخبر.';
$txt['administrators'] = 'مشرفو المنتدى';
$txt['admin_reserved_desc'] = 'هذه الخاصية تسمح لك بمنع الأعضاء من استخدام بعض الكلمات في أسماء الدخول، أو يمكنك تحديد أسماء دخول لحجزها وعدم استخدامها من قبل الأعضاء. قم باختيار ما يناسبك في الأسفل قبل أن تؤكد التغييرات.';
...
$txt['admin_newsletter_send'] = 'هنا يمكنك إرسال الرسائل لمن تريد من الأعضاء. العناوين البريدية لمجموعة الأعضاء المختارة ستظهر في الأسفل، ويمكنك إضافة أو حذف أي بريد من المجموعة. تأكد من أن تفصل بين العناوين البريدية باستخدام الرمز (;) كما في المثال: \'email1; email2\'.';
$txt['admin_fader_delay'] = 'الوقت بالملي ثانية لعرض كل بند في الأخبار المتلاشية';
$txt['admin_bbc'] = 'عرض أزرار رموز المنتدى في صفحات المشاركات و الرسائل الشخصية';
...
$txt['modSettings_info'] = 'تغير أو ضبط الخيارات التي تتحكم بكيفية عمل هذا المنتدى.';
...
$txt['errors_do_recount'] = 'تم إصلاح جميع الأخطاء - وتم إعداد منطقة إنقاذ! الرجاء ضغط الزرّ أدناه لإعادة حساب بعض الإحصائيات الرئيسية';
$txt['errors_recount_now'] = 'إعادة تعداد الإحصائيات';
$txt['errors_fixing'] = 'جاري إصلاح الأخطاء في المنتدى';
$txt['errors_fixed'] = 'تم إصلاح كافة الأخطاء ينجاح! تحقق من أية منتديات، تصنيفات أو مواضيع قد يكون تم إنشاؤها لتقرر ما ستقوم به.';
...
$txt['attachment_stats'] = 'إحصاءات الملفات المرفقة';
$txt['attachment_integrity_check'] = 'فحص المرفقات';
...
$txt['attachmentdir_size'] = 'إجمالي حجم مجلد المرفقات';
$txt['attachmentdir_size_current'] = 'الحجم الكلي لمجلد المرفقات الحالي';
$txt['attachment_space'] = 'إجمالي المساحة المتوفرة في مجلد المرفقات';
$txt['attachment_space_current'] = 'المساحة الكلية المتوفرة في مجلد المرفقات الحالي';
$txt['attachment_options'] = 'خيارات الملفات المرفقة';
$txt['attachment_log'] = 'سجل المرفقات';
$txt['attachment_remove_old'] = 'حذف الملحقات الأقدم من';
$txt['attachment_remove_size'] = 'حذف الملحقات الأكبر من';
$txt['attachment_name'] = 'اسم الملحق';
...
$txt['live'] = 'مباشرة من www.simplemachines.org...';
$txt['remove_all'] = 'حذف الكل';
$txt['approve_new_members'] = 'يجب موافقة المشرف على الأعضاء الجدد';
$txt['agreement_not_writable'] = 'تحذير - ملف agreement.txt غير قابل للكتابة. أية تغيرات قمت بها لن تحفظ';

$txt['version_check_desc'] = 'يعرض لك إصدارة ملفاتك الحالية مقارنة مع آخر الإصدارات المتوفرة. إذا كان هنالك اختلاف فيجب عليك تحميل الملفات الجديدة من <a href="http://www.simplemachines.org/">www.simplemachines.org</a>.';
$txt['version_check_more'] = '(تفاصيل أكثر)';

$txt['lfyi'] = 'لا يمكن الوصول إلى simplemachines.org\'s لعرض ملف آخر الأخبار.';

$txt['manage_calendar'] = 'إدارة التقويم';
$txt['manage_search'] = 'إدارة البحث';

$txt['smileys_manage'] = 'الابتسامات و مجموعة الابتسامات';
$txt['smileys_manage_info'] = 'تثبيت مجموعة ابتسامات جديدة أو إضافة ابتسامات للموجودة حاليا.';
$txt['package_info'] = 'تثبيت مزايا جديدة أو تعديل مزايا موجودة من خلال هذه الصفحة.';
$txt['theme_admin'] = 'إعدادات الشكل و القالب';
$txt['theme_admin_info'] = 'تثبيت و معالجة القوالب أو ضبط خيارات القوالب';
$txt['registration_center'] = 'معالجة التسجيل';
$txt['member_center_info'] = 'مشاهدة قائمة الأعضاء, البحث عن الأعضاء و إدارة الأعضاء الغير موافق عليه و الغير مفعل حسابهم .';

$txt['viewmembers_name'] = 'اسم المستخدم (اسم العرض)';
$txt['viewmembers_online'] = 'آخر وقت متصل';
$txt['viewmembers_today'] = 'اليوم';
$txt['viewmembers_day_ago'] = 'يوم مضى';
$txt['viewmembers_days_ago'] = 'أيام مضت';

$txt['display_name'] = 'اسم العرض';
$txt['email_address'] = 'عنوان البريد';
$txt['ip_address'] = 'IP عنوان';
$txt['member_id'] = 'رقم العضوية';

$txt['unknown'] = 'غير معروف';
$txt['security_wrong'] = 'محاولة دخول الإدارة!' . "\n" . 'Referer: %1$s' . "\n" . 'User agent: %2$s' . "\n" . 'IP: %3$s';

$txt['email_as_html'] = 'بعث على شكل HTML.  (بواسطة هذا يمكنك وضع HTML في البريد.)';
$txt['email_parsed_html'] = 'إضافة &lt;br /&gt;s و &amp;nbsp;s لهذه الرسالة.';
$txt['email_variables'] = 'في هذه الرسالة يمكنك استخدام بعض &quot;المتغيرات&quot;.  انقر <a href="' . $scripturl . '?action=helpadmin;help=emailmembers" onclick="return reqWin(this.href);" class="help">هنا</a> لمعلومات أكثر.';
...
$txt['email_continue'] = 'متابعة';
$txt['email_done'] = 'تمت.';

$txt['ban_title'] = 'حظر الأعضاء';
...
$txt['ban_description'] = 'هنا يمكنك فرض حظر على الأعضاء الغير ملتزمين بواسطة الـIp أو اسم المستضيف أو البريد أو الاسم.';
$txt['ban_add_new'] = 'إضافة حظر جديد';
...
$txt['ban_on_username'] = 'حظر على اسم المستخدم';
...
$txt['ban_trigger_browse_description'] = 'هذه الصفحة تظهر قائمة بالاسماء المخظورة . وفقا للاي بي و الايميل و الاسم..';
...
$txt['ban_log_member'] = 'عضو';
$txt['ban_log_date'] = 'تاريخ';
$txt['ban_log_remove_all'] = 'حذف الكل';
...
$txt['maintain_info'] = 'تحسين فاعلية الجداول ، إنشاء نسخ احتياطية ، فحص الأخطاء ، و تنظيف المنتديات بواسطة هذه الأدوات.';
$txt['maintain_sub_database'] = 'قاعدة المعطيات';
$txt['maintain_sub_routine'] = 'متكرر';
$txt['maintain_sub_members'] = 'الأعضاء';
...
$txt['scheduled_log_desc'] = 'مشاهدة سجلات المهام التي تم تشغيلها';
...
$txt['ssi_db_user'] = 'اسم المستخدم لكي يتم استخدامه في وضعSSI';
...
$txt['theme_settings'] = 'إعدادات القالب';
...
$txt['smileys_default_set_for_theme'] = 'اختر مجموعة الابتسامات الافتراضية لهذا القالب';
$txt['smileys_no_default'] = '(استخدم مجموعة الابتسامات الافتراضية العامة)';

$txt['censor_test'] = 'اختبار الكلمات المراقبة';
$txt['censor_test_save'] = 'تجربة';
$txt['censor_case'] = 'تجاهل حالة الحرف عند المراقبة.';
$txt['censor_whole_words'] = 'تحقق من كامل الكلمة فقط.';

$txt['admin_confirm_password'] = '(تأكيد)';
...
$txt['messenger_address'] = 'عنوان المرسال';
$txt['wild_cards_allowed'] = 'الأقنعة * و ? مسموح بها';
$txt['search_for'] = 'بحث عن';
$txt['member_part_of_these_membergroups'] = 'العضو هو واحد من مجموعة الأعضاء التالية';
$txt['membergroups'] = 'مجموعة الأعضاء';
$txt['confirm_delete_members'] = 'هل ترغب حقا في حذف الأعضاء المعلم عليهم؟';

$txt['support_credits_title'] = 'الدعم و المبرمجون';
$txt['support_credits_info'] = 'احصل على الدعم للمشاكل العامة و كذلك معلومات الإصدارة اذا كان لديك مشاكل.';
$txt['support_title'] = 'معلومات الدعم';
$txt['support_versions_current'] = 'إصدارة SMF الحالية';
$txt['support_versions_forum'] = 'إصدارة المنتدى';
$txt['support_versions_php'] = 'PHP إصدارة';
...
$txt['support_resources_p1'] = 'إن <a href="%1$s">دليل الإستخدام الحى</a> هى الوثائق الخاصة بدعم SMF.  يحتوى هذا الدليل على كثير من الوثائق التى تساعدك فى الإجابة على اسئلتك و يشرح لك <a href="%2$s">الميزات الأساسية</a>, <a href="%3$s">الإعدادات</a>, <a href="%4$s">الإستايلات</a>, <a href="%5$s">الرزم</a>, إلخ. حيث يشمل هذا الدليل شرح لكل جزء من المنتدى SMF و سوف تجد به إجابات عن اسئلتك بشكل سريع. ';
$txt['support_resources_p2'] = 'إذا لم تجد إجابة عن سؤالك فى الدليل الحى, يمكنك البحث فى <a href="%1$s">منتدى الدعم</a> او طلب المساعدة <a href="%2$s">بالقسم الإنجليزى</a> او فى احد اقسام الدعم بالغات الاخرى فى<a href="%3$s">منتدى الدعم متعدد اللغات</a>. إن منتديات الدعم يمكن إستخدامها فى <a href="%4$s">الدعم</a>, <a href="%5$s">البرمجة (التخصيص)</a>, و الكثير من الأشياء كمناقشات حول الـ SMF, البحث عن مواقع إستضافات, و مناقشات حول المشاكل التى قد تواجه مديرى المواقع. ';

$txt['support_latest'] = 'مواضيع الدعم و المشكلات';
$txt['support_latest_fetch'] = 'جلب معلومات الدعم...';

$txt['edit_permissions_info'] = 'تغير التقييدات و الخيارات المتاحة بشكل عام أو لمنتدى محدد.';
$txt['membergroups_members'] = 'أعضاء بدون مجموعات';
$txt['membergroups_guests'] = 'ضيوف غير مسجلين';
$txt['membergroups_guests_na'] = 'غ/م';
$txt['membergroups_add_group'] = 'إضافة مجموعة';
$txt['membergroups_permissions'] = 'تصاريح';

$txt['permitgroups_restrict'] = 'تقييدي';
$txt['permitgroups_standard'] = 'قياسي';
$txt['permitgroups_moderator'] = 'مراقب';
$txt['permitgroups_maintenance'] = 'صيانة';
$txt['permitgroups_inherit'] = 'يرث';

$txt['confirm_delete_attachments_all'] = 'هل ترغب حقا في حذف كافة الملحقات؟';
$txt['confirm_delete_attachments'] = 'هل ترغب حقا في حذف الملحقات التي تم تعليمها؟';
$txt['attachment_manager_browse_files'] = 'استعرض الملفات';
$txt['attachment_manager_repair'] = 'يحافظ على';
$txt['attachment_manager_avatars'] = 'صور الشخصية';
...
$txt['attachment_manager_member'] = 'عضو';
$txt['attachment_manager_avatars_older'] = 'حذف صور الشخصية من الأعضاء الغير نشيطين لأكثر من';
$txt['attachment_manager_total_avatars'] = 'إجمالي صور الشخصية';
...
$txt['attachment_manager_save'] = 'حفظ';
...
$txt['attachmentEncryptFilenames'] = 'تشفير اسماء الملفات المخزنة';
$txt['attachmentUploadDir'] = 'مجلد المرفقات <div class="smalltext"><a href="' . $scripturl . '?action=admin;area=manageattachments;sa=attachpaths">تعديل مجلدات المرفقات</a></div>';
$txt['attachmentUploadDir_multiple'] = 'مجلد المرفقات';
$txt['attachmentUploadDir_multiple_configure'] = '<a href="' . $scripturl . '?action=admin;area=manageattachments;sa=attachpaths">[تعديل مجلدات المرفقات]</a>';
$txt['attachmentDirSizeLimit'] = 'الحجم الاكبر لمجلد المرفقات';
$txt['attachmentPostLimit'] = 'الحجم الكلي للمرفقات في الموضوع الواحد';
$txt['attachmentSizeLimit'] = 'حجم المرفق الواحد';
$txt['attachmentNumPerPostLimit'] = 'عدد المرفقات في كل موضوع';
...
$txt['attachment_image_reencode_note'] = 'يتطلب عمل GD module.';
...
$txt['attach_dir_files_missing'] = 'بعض الملفات مفقودة (<a href="' . $scripturl . '?action=admin;area=manageattachments;sa=repair;%2$s=%1$s">إصلاح</a>)';
$txt['attach_dir_unused'] = 'غير مستخدم';
$txt['attach_dir_ok'] = 'موافق';

$txt['attach_path_manage'] = 'إدارة مسارات المرفقات';
$txt['attach_paths'] = 'مسارات المرفقات';
$txt['attach_current_dir'] = 'المجلد الحالي';
$txt['attach_path'] = 'المسار';
$txt['attach_current_size'] = 'الحجم الحالي بالكيلوبيات';
...
$txt['mods_cat_avatars'] = 'الصور الشخصية';
$txt['avatar_directory'] = 'مجلد الصور الشخصية';
$txt['avatar_url'] = 'عنوان الصورة الشخصية';
$txt['avatar_dimension_note'] = 'استخدم صفر (0) لجعل القيمة غير محدودة';
$txt['avatar_max_width_external'] = 'اكبر عرض للصورة الشخصية';
$txt['avatar_max_height_external'] = 'اكبر ارتفاع للصورة الشخصية';
$txt['avatar_action_too_large'] = 'اذا كانت الصورة الشخصية كبيرة جدا...';
$txt['option_refuse'] = 'قم برفضها';
$txt['option_html_resize'] = 'تعديل حجمها باستخدام HTML';
$txt['option_js_resize'] = 'تعديل حجمها باستخدام JavaScript';
$txt['option_download_and_resize'] = 'تنزيلها و تعديل حجمها(تحتاج GD module)';
$txt['avatar_max_width_upload'] = 'اكبر عرض للصورة الشخصية المحملة';
$txt['avatar_max_height_upload'] = 'اكبر ارتفاع للصورة الشخصية المحملة';
$txt['avatar_resize_upload'] = 'تعديل حجم الصور الشخصية الكبيرة ';
$txt['avatar_resize_upload_note'] = '(تتطلب GD module)';
$txt['avatar_download_png'] = 'تحويل الصور المعدلة إلى الإمتداد PNG';
$txt['avatar_gd_warning'] = 'مكتبة الـ GD غير مثبتة حاليا. بعض خصائص الصور الرمزية غير مفعلة.';
$txt['avatar_external'] = 'صور شخصية اضافية';
$txt['avatar_upload'] = 'صور شخصية قابلة للتحميل';
$txt['avatar_server_stored'] = 'صور شخصية مخزنة';
$txt['avatar_server_stored_groups'] = 'مسموح لمجموعة الاعضاء اختيار الصورة الشخصية من الصور المخزنة';
$txt['avatar_upload_groups'] = 'مسموح لمجموعة الاعضاء تحميل الصورة الشخصية';
$txt['avatar_external_url_groups'] = 'مسموح لمجموعة الاعضاء وضع رابط للصورة الشخصية';
...
$txt['custom_avatar_dir_desc'] = 'هذا يجب ألا يكون مثل مجلد التخزين للسيرفر.';
...
$txt['repair_attachments_no_errors'] = 'لم ييم العثور على أي أخطاء';
...
$txt['repair_attachments_continue'] = 'الإستمرار';
...
$txt['attach_repair_wrong_folder'] = '%1$d المرفقات في المجلد الخطأ';

$txt['news_title'] = 'تحرير الاخبار';
$txt['news_settings_desc'] = 'بامكانك تغيير الاعدادات للاخبار و الرسال البريدية';
$txt['news_settings_submit'] = 'حفظ';
$txt['news_mailing_desc'] = 'بامكانك ارسال رسائل الى جميع الاعضاء من هنا.';
...
$txt['xmlnews_maxlen'] = 'اكبر طول للرسالة:<div class="smalltext">(0 لتعطيلها, فكرة غير محبذة.)</div>';
$txt['editnews_clickadd'] = 'اضف خانة جديدة.';
$txt['editnews_remove_selected'] = 'حذف المعلم';
$txt['editnews_remove_confirm'] = 'هل انت متاكد انك تريد حذف الاخبار المختارة؟?';
$txt['censor_clickadd'] = 'انقر هنا لإضافة كلمة جديدة.';

$txt['layout_controls'] = 'المنتدى';
$txt['logs'] = 'السجلات';
$txt['generate_reports'] = 'تكوين التقارير';

$txt['update_available'] = 'التحديث متوفر!';
$txt['update_message'] = 'انت تستخدم نسخة غير محدثة من SMF قد تحتوي على مجموعة من المشاكل.
	من المفضل ان <a href="" id="update-link"> تحدث المنتدى </a> الى احدث نسخة في اسرع فرصة. ولنتاخذ اكثرمن دقيقة واحدة!';
...
$txt['manageposts_posts'] = 'مواضيع';
$txt['manageposts_topics'] = 'عناوين';
...
$txt['manageposts_settings_submit'] = 'حفظ';
...
$txt['manageposts_bbc_settings_title'] = 'اعدادات أوامر الترميز في المنتدى';
$txt['manageposts_bbc_settings_submit'] = 'حفظ';
...
$txt['manageposts_topic_settings_submit'] = 'حفظ';

$txt['removeNestedQuotes'] = 'إلغاء الاقتباسات المتداخلة عند الإرسال';
$txt['enableEmbeddedFlash'] = 'دمج الفلاش في الموضوع';
$txt['enableEmbeddedFlash_warning'] = 'قد يشكل خطرا امنيا!';
$txt['enableSpellChecking'] = 'تفعيل التصحيح الاملائي';
$txt['enableSpellChecking_warning'] = 'هذه الميزة لاتعمل على جميع السيرفرات!';
$txt['disable_wysiwyg'] = 'تعطيل محرر WYSIWYG';
$txt['max_messageLength'] = 'اكبر حجم للموضوع';
$txt['max_messageLength_zero'] = '0 لغير محدد.';
$txt['fixLongWords'] = 'تقسيم الكلمات التي تحتوي على حروف اكثر من';
$txt['fixLongWords_zero'] = 'استخدم القيمة 0 للتعطيل';
$txt['fixLongWords_warning'] = 'قد لا يعمل على جميع السيرفارات .';
...
$txt['disabledBBC'] = 'تفعيل ترويسات الـ BBC';
...
$txt['enableStickyTopics'] = 'تفعيل المواضيع المثبتة';
...
$txt['load_balancing_settings'] = 'موازنة الحمل';

$txt['language_configuration'] = 'اللغات';
$txt['language_description'] = 'هنا يمكنك تعديل اللغات المثبته فى المنتدى الخاص بك , قم بتحميل لغه جديده من  موقع Simple Machines . يمكنك أيضا تعديل إعدادات اللغات هنا .';
$txt['language_edit'] = 'تعديل اللغات';
$txt['language_add'] = 'إضافة لغه';
$txt['language_settings'] = 'إعدادات';

$txt['advanced'] = 'متقدم';
$txt['simple'] = 'بسيط';

$txt['admin_news_select_recipients'] = 'أرجو اختيار من يجب أن يحصل على نسخة من البريد الإخباري';
$txt['admin_news_select_group'] = 'المجموعات';
$txt['admin_news_select_group_desc'] = 'اختر المجموعات التي سيصلها البريد الإخباري.';
$txt['admin_news_select_members'] = 'الأعضاء';
$txt['admin_news_select_members_desc'] = 'أعضاء إضافيين لكي يستلموا البريد الإخباري.';
$txt['admin_news_select_excluded_members'] = 'الأعضاء المستثنين';
$txt['admin_news_select_excluded_members_desc'] = 'الأعضاء الذين لا يجب أن يستلمو رسائل الأخبارية.';
...
$txt['admin_news_select_email_desc'] = 'فاصلة منقوطة تفصل قائمة الايميلات التي يجب أن يتم إرسال رسائل إخبارية لها. (i.e. address1; address2)';
$txt['admin_news_select_override_notify'] = 'إعادة تغيير خيارات التنبيه';
...
$txt['mailqueue_settings'] = 'إعدادات البريد';

$txt['admin_search'] = 'بحث سريع';
$txt['admin_search_type_internal'] = 'وظيفة/خيارات';
$txt['admin_search_type_member'] = 'عضو';
...
$txt['admin_search_results_none'] = 'لا توجد نتائج!';
...
$txt['mboards_new_cat'] = 'إنشاء تصنيف جديد';
...
$txt['smileys_set_order'] = 'تحديد ترتيب الابتسامات';
$txt['icons_edit_message_icons'] = 'إضافة صورة رمزية (ايكون) للمشاركات';

$txt['membergroups_new_group'] = 'إضافة مجموعات جديدة';
$txt['membergroups_edit_groups'] = 'تعديل المجموعات';
