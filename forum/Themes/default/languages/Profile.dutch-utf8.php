...
$txt['msn_email_address'] = 'Je MSN Messenger-e-mailadres';
...
$txt['authentication_openid_email'] = 'Stuur me per e-mail een herinnering van mijn OpenID-identiteit';
$txt['authentication_openid_secret'] = 'Beantwoord mijn &quot;geheime vraag&quot; om mijn OpenID-identiteit weer te geven';
...
$txt['openid_secret_reminder'] = 'Vul je antwoord op de vraag hieronder in. Als je het juist hebt, zal je OpenID-identiteit hieronder weergegeven worden.';
$txt['reminder_openid_is'] = 'De OpenID-identiteit gekoppeld aan jouw account is:<br />&nbsp;&nbsp;&nbsp;&nbsp;<strong>%1$s</strong><br /><br />Maak hier een aantekening van voor toekomstige naslag.';
...
$txt['authentication'] = 'Authenticatie';
$txt['change_authentication'] = 'Vanuit deze sectie kun je instellen hoe je wilt inloggen op het forum. Je kunt ervoor kiezen om een OpenID-account te gebruiken, of om over te stappen op een gebruikersnaam en wachtwoord.';
...
$txt['forumProfile_info'] = 'Je kunt hier je persoonlijke informatie aanpassen. Deze informatie wordt getoond op ' . $context['forum_name_html_safe'] . '. Indien je dit niet wilt, sla dit dan over en laat het leeg.';
...
$txt['reminder_mail'] = 'Je ontvangt deze mail omdat de \'Wachtwoord vergeten\' functie voor jouw account is gebruikt. Om een nieuw wachtwoord in te stellen, klik je op de volgende link';
...
$txt['reminder_openid_sent'] = 'Je huidige OpenID-identiteit is verstuurd naar je e-mailadres.';
...
$txt['use_sidebar_menu'] = 'Gebruik menu\'s aan de zijkant in plaats van uitrolmenu\'s waar mogelijk.';
...
$txt['profile_view_warnings'] = 'Bekijk waarschuwingen';
...
$txt['profile_warning_name'] = 'Naam lid';
...
$txt['profile_warning_notify_template_outline'] = '{MEMBER},' . "\n\n" . 'Je hebt een waarschuwing gekregen wegens %1$s. Laat dit soort acties in het vervolg achterwege en houd je aan de forumregels, anders zijn we genoodzaakt verdere maatregelen te nemen.' . "\n\n" . '{REGARDS}';
$txt['profile_warning_notify_template_outline_post'] = '{MEMBER},' . "\n\n" . 'Je hebt een waarschuwing gekregen voor %1$s met betrekking tot het volgende bericht:' . "\n" . '{MESSAGE}.' . "\n\n" . 'Laat dit soort acties in het vervolg achterwege en houd je aan de forumregels, anders zijn we genoodzaakt verdere maatregelen te nemen.' . "\n\n" . '{REGARDS}';
...
$txt['profile_warning_previous'] = 'Voorgaande waarschuwingen';
...
$txt['copy_to_outbox'] = 'Sla standaard een persoonlijk bericht op in mijn postvak uit.';
...
$txt['pm_recommend_enable_outbox'] = 'Om het meeste uit deze instelling te halen, wordt je aangeraden om &quot;Sla standaard een persoonlijk bericht op in mijn postvak uit&quot; aan te zetten.\\n\\nDit zal ervoor zorgen dat de gesprekken beter te volgen zijn, omdat je dan beide kanten kunt lezen.';
