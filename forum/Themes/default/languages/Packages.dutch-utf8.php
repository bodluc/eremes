...
$txt['php_script'] = 'Het modificatiebestand is uitgepakt, maar bij deze modificatie hoort een PHP-script dat eerst dient te worden uitgevoerd voor de modificatie zal werken.';
$txt['package_run'] = 'Starten';
$txt['package_read'] = 'Lezen';
$txt['script_output'] = 'Scriptuitvoer:';
$txt['additional_notes'] = 'Additionele informatie';
$txt['notes_file'] = 'Instructie/informatiebestand';
$txt['list_file'] = 'Lijst van bestanden in het pakket';
$txt['files_archive'] = 'Bestanden in het archief';
$txt['package_get'] = 'Pakket verkrijgen';
$txt['package_servers'] = 'Pakketservers';
$txt['package_browse'] = 'Bladeren';
$txt['add_server'] = 'Server toevoegen';
$txt['server_name'] = 'Servernaam';
$txt['serverurl'] = 'URL';
$txt['no_packages'] = 'Nog geen pakketten';
$txt['download'] = 'Downloaden';
$txt['download_success'] = 'Pakket is gedownload';
$txt['package_downloaded_successfully'] = 'Het pakket is met succes gedownload';
$txt['package_manager'] = 'Pakketbeheer';
$txt['install_mod'] = 'Installeer modificatie';
$txt['uninstall_mod'] = 'De&iuml;nstalleer modificatie';
$txt['sql_file'] = 'Het modificatiebestand is uitgepakt. Het bevat ook een SQL-bestand met modificaties voor de database. Dit dien je apart uit te voeren.';
$txt['sql_queries'] = 'SQL-queries';
$txt['no_mods_installed'] = 'Er zijn momenteel geen modificaties ge&iuml;nstalleerd';
$txt['browse_installed'] = 'Bekijk de ge&iuml;nstalleerde modificaties';
$txt['uninstall'] = 'De&iuml;nstalleer';
$txt['delete_list'] = 'Verwijder de modificatielijst';
$txt['php_safe_mode'] = 'Sorry, je server draait PHP in <strong>safe mode</strong>. Deze feature is helaas niet compatibel met SAFE MODE.';
$txt['lets_try_anyway'] = 'Probeer het toch.';

$txt['package_manager_desc'] = 'Met het pakketbeheer kun je modificaties naar je forum downloaden en installeren met behulp van een eenvoudige interface.';
...
$txt['download_packages_desc'] = 'Vanuit deze sectie kun pakketten van de pakketserver downloaden of een pakketbestand direct uploaden naar je forum.';

$txt['create_package'] = 'Nieuw pakket maken';
$txt['download_new_package'] = 'Nieuw pakket downloaden';
$txt['view_and_remove'] = 'Bekijken en verwijderen van ge&iuml;nstalleerde pakketten';
$txt['modification_package'] = 'Modificatiepakketten';
$txt['avatar_package'] = 'Avatarpakketten';
$txt['language_package'] = 'Taalpakketten';
$txt['unknown_package'] = 'Onbekende pakketten';
$txt['use_avatars'] = 'Gebruik avatars';
$txt['add_languages'] = 'Voeg taalpakket toe';
$txt['list_files'] = 'Overzicht bestanden';
$txt['remove'] = 'Verwijder';
$txt['package_type'] = 'Pakkettype';
$txt['archiving'] = 'Archiveren';
$txt['extracting'] = 'Uitpakken';
$txt['avatars_extracted'] = 'De avatars zijn uitgepakt; je kunt ze vanaf nu gebruiken.';
$txt['language_extracted'] = 'Het taalpakket is uitgepakt; je kunt deze nu selecteren in de instellingen.';

$txt['mod_name'] = 'Modificatienaam';
$txt['mod_version'] = 'Versie';
$txt['mod_author'] = 'Auteur';
$txt['author_website'] = 'Website van de maker';
$txt['package_no_description'] = 'Geen beschrijving opgegeven';
$txt['package_description'] = 'Beschrijving';
$txt['file_location'] = 'Locatie van het bestand';

$txt['package_installed_key'] = 'Ge&iuml;nstalleerde mods:';
$txt['package_installed_current'] = 'huidige versie';
$txt['package_installed_old'] = 'oudere versie';
$txt['package_installed_warning1'] = 'Dit pakket is reeds ge&iuml;nstalleerd en er kon geen upgrade worden gevonden!';
...
$txt['packages_latest'] = 'Nieuwste pakketten';
$txt['packages_latest_fetch'] = 'Er wordt geprobeerd de populairste en meest recente pakketten van www.simplemachines.org te downloaden...';
...
$txt['package_install_desc'] = 'Omschrijving';
$txt['install_actions'] = 'Installatie-acties';
$txt['perform_actions'] = 'Installatie van dit pakket zal de volgende acties uitvoeren:';
$txt['corrupt_compatible'] = 'Er zijn geen installatie-acties gedefinieerd!';
$txt['package_create'] = 'Maken';
$txt['package_move'] = 'Verplaatsen';
$txt['package_delete'] = 'Verwijderen';
...
$txt['execute_database_changes'] = 'Pas database aan';
...
$txt['package_will_fail_warning'] = 'Ten minste &eacute;&eacute;n fout is opgetreden bij de testinstallatie van dit pakket.
	Het wordt <strong>ten zeerste</strong> aanbevolen dat je niet doorgaat met de installatie, tenzij je weet wat je doet, en recentelijk een backup gemaakt hebt.
	Deze fout kan veroorzaakt zijn door een conflict tussen een reeds ge&iuml;nstalleerde mod, een fout in het pakket, een pakket dat een ander pakket vereist dat je niet ge&iuml;nstalleerd hebt, of een pakket dat voor een andere versie van SMF is gemaakt.';
// Don't use entities in the below string.
$txt['package_will_fail_popup'] = 'Weet je zeker dat je deze modificatie wilt installeren, ondanks dat dit niet succesvol kan verlopen?';
$txt['package_will_fail_popup_uninstall'] = 'Weet je zeker dat je deze modificatie wilt de&iuml;nstalleren, ondanks dat dit niet succesvol kan verlopen?';
$txt['package_install_now'] = 'Nu installeren';
$txt['package_uninstall_now'] = 'Nu de&iuml;nstalleren';
$txt['package_other_themes'] = 'Installeer in andere thema\'s';
$txt['package_other_themes_uninstall'] = 'De&iuml;nstalleer in andere thema\'s';
$txt['package_other_themes_desc'] = 'Om deze modificatie in andere thema\'s dan de standaard te kunnen gebruiken moet de pakketbeheerder extra aanpassingen aan de andere thema\'s verrichten. Als je deze modificatie in andere thema\'s wilt gebruiken, selecteer deze thema\'s dan hieronder.';
// Don't use entities in the below string.
...
$txt['package_uninstall_cannot'] = 'Dit pakket kan niet worden gede&iuml;nstalleerd omdat er geen de&iuml;nstallatieprogramma is!<br /><br />Neem contact op met de mod auteur voor meer informatie.';
...
$txt['package_ftp_why'] = 'Sommige bestanden die het pakketbeheer moet veranderen zijn niet beschrijfbaar. Dit moet veranderd worden door met FTP in te loggen, waarmee de bestanden en mappen worden aangemaakt en gechmod. Je FTP-informatie wordt tijdelijk in het geheugen opgeslagen zodat het pakketbeheer het werk kan uitvoeren. Je kunt dit ook zelf via een FTP-programma doen; om een lijst van de bestanden in kwestie te bekijken, klik je <a href="#" onclick="%1$s">here</a>.';
...
$txt['package_ftp_why_download'] = 'Om pakketten te kunnen downloaden, moet de map \'Packages\' beschrijfbaar zijn, wat momenteel niet het geval is. Het pakketbeheer kan middels FTP dit probleem verhelpen.';
...
$txt['package_ftp_path'] = 'FTP-pad van SMF';
...
$txt['package_modification_malformed'] = 'Misvormd of ongeldig modificatiebestand.';
...
$txt['package_db_uninstall'] = 'Verwijder alle data geassocieered met deze modificatie.';
$txt['package_db_uninstall_details'] = 'Details';
$txt['package_db_uninstall_actions'] = 'Het aanvinken van deze optie heeft de volgende databasewijzigingen tot gevolg';
...
$txt['package_advanced_button'] = 'Geavanceerd';
$txt['package_advanced_options'] = 'Geavanceerde instellingen';
$txt['package_apply'] = 'Toepassen';
$txt['package_emulate'] = 'Emuleer versie';
$txt['package_emulate_revert'] = 'Terugkeren';
$txt['package_emulate_desc'] = 'Soms zijn pakketten vergrendeld voor eerdere versies van SMF, maar zijn ze eigenlijk nog wel compatibel met een nieuwe versie. Hier kun je kiezen om een andere versie van SMF te &quot;emuleren&quot; binnen het pakketbeheer.';
...
$txt['package_file_perms_predefined_note'] = 'NB: het profiel wordt alleen toegepast op de sleutelbestanden en -mappen van SMF.';
...
$txt['package_file_perms_ftp_retain'] = 'Opmerking: SMF zal het wachtwoord slechts tijdelijk onthouden voor het functioneren van de pakketbeheerder.';
...
$txt['package_restore_permissions'] = 'Herstel bestandspermissies';
$txt['package_restore_permissions_desc'] = 'De volgende bestandspermissies zijn aangepast door SMF om de geselecteerde pakketten te installeren. Je kunt deze bestanden weer hun originele status geven door op de &quot;Herstel&quot;-knop hieronder te klikken.';
$txt['package_restore_permissions_restore'] = 'Herstel';
...
$txt['package_restore_permissions_action_success'] = '<span style="color: green;">Succes</span>';
$txt['package_restore_permissions_action_failure'] = '<span class="error">Mislukt</span>';
$txt['package_restore_permissions_action_done'] = 'SMF heeft geprobeerd om de geselecteerde bestanden hun originele permissies terug te geven. De resultaten staan hieronder. Mocht een verandering mislukt zijn, of wil je een gedetailleerder overzicht zien, bekijk dan de sectie <a href="%1$s">bestandspermisses</a>.';

$txt['package_file_perms_warning'] = 'Opmerking';
$txt['package_file_perms_warning_desc'] = '
	<li>Wees voorzichtig met het veranderen van bestandspermissies vanuit deze sectie. Onjuiste permissies kunnen leiden tot een niet-functionerend forum!</li>
	<li>Bij sommige serverconfiguraties kan het kiezen van de verkeerde permissies leiden tot het compleet stilleggen van SMF.</li>
	<li>Bepaalde mappen, zoals <em>attachments</em>, moeten beschrijfbaar zijn om de functionaliteit te kunnen gebruiken.</li>
	<li>Deze functie is voornamelijk van toepassing op servers die niet op Windows werken. Het zal niet zoals verwacht werken op Windows, omdat dat een ander permissiesysteem gebruikt.</li>
	<li>Voordat je doorgaat: verzeker jezelf ervan dat je een FTP-client ge&iuml;nstalleerd hebt, voor het geval je een fout maakt en je FTP nodig hebt om de fout te herstellen.</li>';

$txt['package_confirm_view_package_content'] = 'Weet je zeker dat je de pakketinhoud van deze locatie wilt ophalen:<br /><br />%1$s';
$txt['package_confirm_proceed'] = 'Doorgaan';
