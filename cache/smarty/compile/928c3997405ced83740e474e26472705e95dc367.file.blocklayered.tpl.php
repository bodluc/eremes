<?php /* Smarty version Smarty-3.1.8, created on 2013-02-09 00:09:23
         compiled from "/home/bodo/public_html/dev/modules/blocklayered/blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1086261554511585a36603c8-70726950%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '928c3997405ced83740e474e26472705e95dc367' => 
    array (
      0 => '/home/bodo/public_html/dev/modules/blocklayered/blocklayered.tpl',
      1 => 1359211000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1086261554511585a36603c8-70726950',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_511585a3e0f5a7_06484755',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_511585a3e0f5a7_06484755')) {function content_511585a3e0f5a7_06484755($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/bodo/public_html/dev/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_sortby')) include '/home/bodo/public_html/dev/tools/smarty/plugins/modifier.sortby.php';
?>
...
"<?php }?>>
										...
										<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['id_value'] = new Smarty_Variable;
 $_from = smarty_modifier_sortby($_smarty_tpl->tpl_vars['filter']->value['values'],"#name"); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
 $_smarty_tpl->tpl_vars['id_value']->value = $_smarty_tpl->tpl_vars['value']->key;
?>
