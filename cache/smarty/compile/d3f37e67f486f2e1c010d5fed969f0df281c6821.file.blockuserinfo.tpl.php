<?php /* Smarty version Smarty-3.1.8, created on 2013-02-09 14:37:02
         compiled from "/home/bodo/public_html/dev/modules/blockuserinfo/blockuserinfo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1794360120511650fe6e7e18-06408127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3f37e67f486f2e1c010d5fed969f0df281c6821' => 
    array (
      0 => '/home/bodo/public_html/dev/modules/blockuserinfo/blockuserinfo.tpl',
      1 => 1357484127,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1794360120511650fe6e7e18-06408127',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_511650fe7bdf30_16494492',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_511650fe7bdf30_16494492')) {function content_511650fe7bdf30_16494492($_smarty_tpl) {?>
...
" class="logout"><?php echo smartyTranslate(array('s'=>'Log out','mod'=>'blockuserinfo'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
            <a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true);?>
" class="login"><?php echo smartyTranslate(array('s'=>'Rejestracja','mod'=>'blockuserinfo'),$_smarty_tpl);?>
</a>
            <a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true);?>
" class="login2"><?php echo smartyTranslate(array('s'=>'Logowanie','mod'=>'blockuserinfo'),$_smarty_tpl);?>
</a>
			
		<?php }?>
       <!-- 
        <a href="https://www.facebook.com/AudioRMSpl" class="logowanie_facebook" ><img src="<?php echo $_smarty_tpl->tpl_vars['module_dir']->value;?>
img/fb_connect.png"></a>
        -->
	</p>
</div>
<!-- /Block user information module HEADER -->
