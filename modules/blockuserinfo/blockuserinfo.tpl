...
<div id="header_user">
	...
	<p id="header_user_info">
		...
		{else}
            <a href="{$link->getPageLink('my-account', true)}" class="login">{l s='Rejestracja' mod='blockuserinfo'}</a>
            <a href="{$link->getPageLink('my-account', true)}" class="login2">{l s='Logowanie' mod='blockuserinfo'}</a>
			
		{/if}
       <!-- 
        <a href="https://www.facebook.com/AudioRMSpl" class="logowanie_facebook" ><img src="{$module_dir}img/fb_connect.png"></a>
        -->
	</p>
</div>
<!-- /Block user information module HEADER -->
