...
( function( $ ) {
    ...
    $.plusSlider = function( el, options ) {
        ...
        base.init = function () {
            ...
            base.sliderWidth            = 1;                              //Stores the slider width value. This changes on resize if fullWidth is enableds
    ...
    $.plusSlider.defaults = {
        ...
        nextText            : 'Następny', // Adds text to the 'next' trigger
        prevText            : 'Poprzedni', // Adds text to the 'prev' trigger
