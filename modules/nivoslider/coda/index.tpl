    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{$base_dir_ssl}{$module_dir}coda/css/coda-slider.css">





    <script src="{$base_dir_ssl}{$module_dir}coda/js/jquery.coda-slider-3.0.min.js"></script>
