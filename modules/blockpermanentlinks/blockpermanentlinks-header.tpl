...
<ul id="header_links">
    ...
    <li id="header_link_contact"><a href="{$link->getPageLink('contact', true)}" title="{l s='contact' mod='blockpermanentlinks'}">{l s='Status Zamówienia' mod='blockpermanentlinks'}</a></li>
